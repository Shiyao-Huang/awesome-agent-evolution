# Hourly Public Metadata Update - 2026-07-04 01:40 +0800

## One Sentence

Refreshed the tracked GitHub anchors at 2026-07-04 01:40 +0800, propagated the fresher metadata through raw captures, classification, README, Mermaid, site reports, and index-facing surfaces, and removed duplicate front-page metadata blocks.
...
| `NousResearch/hermes-agent` | 208,568 | 37,970 | 14,335 | 8,449 | 16,901 | gh_graphql |
| `stanford-iris-lab/meta-harness` | 1,195 | 116 | 11 | 6 | 0 | gh_graphql |
| `rohitg00/agentmemory` | 24,505 | 2,018 | 463 | 170 | 185 | gh_graphql |
| `pinchbench/skill` | 1,260 | 144 | 383 | 21 | 0 | gh_graphql |
| `lsdefine/GenericAgent` | 13,280 | 1,534 | 895 | 94 | 69 | gh_graphql |
| `openclaw/openclaw` | 381,585 | 79,999 | 63,607 | 3,563 | 3,428 | gh_graphql |
| `obra/superpowers` | 245,358 | 21,742 | 628 | 145 | 168 | gh_graphql |
...
- Real public deltas vs 2026-07-03 19:38 +0800: `china-qijizhifeng/agentic-Harness-engineering`, `NousResearch/hermes-agent`, `stanford-iris-lab/meta-harness`, `rohitg00/agentmemory`, `lsdefine/GenericAgent`, `openclaw/openclaw`, `obra/superpowers`, `desplega-ai/agent-swarm`.
