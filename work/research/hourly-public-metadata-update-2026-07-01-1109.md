# Hourly Public Metadata Update - 2026-07-01 11:09 +0800

## One Sentence

Refreshed the tracked GitHub anchors at 2026-07-01 11:09 +0800, propagated the fresher metadata through raw captures, classification, README, Mermaid, site reports, and index-facing surfaces, and removed duplicate front-page metadata blocks.
...
| `NousResearch/hermes-agent` | 206,580 | 37,373 | 13,844 | 8,169 | 16,570 | gh_graphql |
| `stanford-iris-lab/meta-harness` | 1,177 | 113 | 11 | 5 | 0 | gh_graphql |
| `rohitg00/agentmemory` | 24,366 | 2,001 | 463 | 166 | 181 | gh_graphql |
| `pinchbench/skill` | 1,257 | 143 | 383 | 21 | 0 | gh_graphql |
| `lsdefine/GenericAgent` | 13,218 | 1,527 | 894 | 93 | 65 | gh_graphql |
| `openclaw/openclaw` | 381,197 | 79,855 | 62,876 | 3,417 | 3,286 | gh_graphql |
| `obra/superpowers` | 242,637 | 21,528 | 618 | 142 | 155 | gh_graphql |
| `EvoMap/awesome-agent-evolution` | 149 | 20 | 68 | 8 | 1 | gh_graphql |
| `uid4oe/insight-swarm` | 0 | 0 | 25 | 0 | 0 | gh_graphql |
| `desplega-ai/agent-swarm` | 565 | 63 | 1,716 | 1 | 6 | gh_graphql |

## Delta Summary

- Real public deltas vs 2026-07-01 05:07 +0800: `NousResearch/hermes-agent`, `stanford-iris-lab/meta-harness`, `rohitg00/agentmemory`, `pinchbench/skill`, `lsdefine/GenericAgent`, `openclaw/openclaw`, `obra/superpowers`, `EvoMap/awesome-agent-evolution`, `desplega-ai/agent-swarm`.
...
- `(cd paper-drafts && xelatex -interaction=nonstopmode -halt-on-error main.tex)` passed and produced a 210-page `main.pdf`; existing Chinese-glyph and table layout warnings remain in generated English analysis tables.
