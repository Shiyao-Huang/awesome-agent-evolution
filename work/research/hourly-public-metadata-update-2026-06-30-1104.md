# Hourly Public Metadata Update - 2026-06-30 11:04 +0800

## One Sentence

Refreshed the tracked GitHub anchors at 2026-06-30 11:04 +0800, propagated the fresher metadata through raw captures, classification, README, Mermaid, site reports, and index-facing surfaces, and removed duplicate front-page metadata blocks.
...
|---|---:|---:|---:|---:|---:|---|
| `china-qijizhifeng/agentic-Harness-engineering` | 652 | 74 | 46 | 2 | 0 | gh_graphql |
| `NousResearch/hermes-agent` | 205,808 | 37,180 | 13,568 | 8,070 | 16,450 | gh_graphql |
| `stanford-iris-lab/meta-harness` | 1,173 | 113 | 11 | 5 | 0 | gh_graphql |
| `rohitg00/agentmemory` | 24,307 | 1,995 | 463 | 165 | 180 | gh_graphql |
| `pinchbench/skill` | 1,256 | 143 | 383 | 22 | 0 | gh_graphql |
| `lsdefine/GenericAgent` | 13,197 | 1,528 | 891 | 93 | 65 | gh_graphql |
| `openclaw/openclaw` | 381,037 | 79,816 | 62,741 | 3,371 | 3,253 | gh_graphql |
| `obra/superpowers` | 241,615 | 21,451 | 609 | 139 | 152 | gh_graphql |
| `EvoMap/awesome-agent-evolution` | 147 | 20 | 68 | 8 | 1 | gh_graphql |
| `uid4oe/insight-swarm` | 0 | 0 | 25 | 0 | 0 | gh_graphql |
| `desplega-ai/agent-swarm` | 557 | 62 | 1,703 | 1 | 5 | gh_graphql |

## Delta Summary

- Real public deltas vs 2026-06-30 05:03 +0800: `china-qijizhifeng/agentic-Harness-engineering`, `NousResearch/hermes-agent`, `stanford-iris-lab/meta-harness`, `rohitg00/agentmemory`, `pinchbench/skill`, `lsdefine/GenericAgent`, `openclaw/openclaw`, `obra/superpowers`, `EvoMap/awesome-agent-evolution`, `desplega-ai/agent-swarm`.
