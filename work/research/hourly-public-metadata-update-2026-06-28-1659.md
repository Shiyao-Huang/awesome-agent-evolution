# Hourly Public Metadata Update - 2026-06-28 16:59 +0800

## One Sentence

Refreshed the tracked GitHub anchors at 2026-06-28 16:59 +0800, propagated the fresher metadata through raw captures, classification, README, Mermaid, site reports, and index-facing surfaces, and removed duplicate front-page metadata blocks.
...
| `NousResearch/hermes-agent` | 204,551 | 36,841 | 13,288 | 7,822 | 16,161 | gh_graphql |
| `stanford-iris-lab/meta-harness` | 1,167 | 113 | 11 | 5 | 0 | gh_graphql |
| `rohitg00/agentmemory` | 24,175 | 1,989 | 462 | 161 | 177 | gh_graphql |
| `pinchbench/skill` | 1,255 | 143 | 383 | 21 | 0 | gh_graphql |
| `lsdefine/GenericAgent` | 13,133 | 1,525 | 887 | 95 | 63 | gh_graphql |
| `openclaw/openclaw` | 380,783 | 79,770 | 62,473 | 3,364 | 3,349 | gh_graphql |
| `obra/superpowers` | 240,273 | 21,329 | 609 | 135 | 151 | gh_graphql |
| `EvoMap/awesome-agent-evolution` | 145 | 20 | 67 | 8 | 1 | gh_graphql |
| `uid4oe/insight-swarm` | 0 | 0 | 25 | 0 | 0 | gh_graphql |
| `desplega-ai/agent-swarm` | 551 | 62 | 1,688 | 1 | 7 | gh_graphql |

## Delta Summary

- Real public deltas vs 2026-06-28 10:59 +0800: `NousResearch/hermes-agent`, `rohitg00/agentmemory`, `pinchbench/skill`, `lsdefine/GenericAgent`, `openclaw/openclaw`, `obra/superpowers`, `desplega-ai/agent-swarm`.
...
- Astro site build passed and generated 1000 pages; warnings are existing Astro/Zod deprecation hints, one unused variable hint, a deprecated `document.execCommand` hint, and bundle-size warnings.
