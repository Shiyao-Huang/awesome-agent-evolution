# Hourly Public Metadata Update - 2026-06-26 22:53 +0800

## One Sentence

Refreshed the tracked GitHub anchors at 2026-06-26 22:53 +0800, propagated the fresher metadata through raw captures, classification, README, Mermaid, site reports, and index-facing surfaces, and removed duplicate front-page metadata blocks.
...
| `NousResearch/hermes-agent` | 203,583 | 36,497 | 13,037 | 7,775 | 16,080 | gh_graphql |
| `stanford-iris-lab/meta-harness` | 1,162 | 113 | 11 | 5 | 0 | gh_graphql |
| `rohitg00/agentmemory` | 24,101 | 1,977 | 462 | 158 | 175 | gh_graphql |
| `pinchbench/skill` | 1,252 | 143 | 383 | 21 | 0 | gh_graphql |
| `lsdefine/GenericAgent` | 13,104 | 1,523 | 887 | 94 | 61 | gh_graphql |
| `openclaw/openclaw` | 380,560 | 79,713 | 62,350 | 3,348 | 3,329 | gh_graphql |
| `obra/superpowers` | 239,247 | 21,229 | 609 | 135 | 150 | gh_graphql |
| `EvoMap/awesome-agent-evolution` | 144 | 20 | 67 | 8 | 1 | gh_graphql |
| `uid4oe/insight-swarm` | 0 | 0 | 25 | 0 | 0 | gh_graphql |
| `desplega-ai/agent-swarm` | 549 | 60 | 1,679 | 1 | 5 | gh_graphql |

## Delta Summary

- Real public deltas vs 2026-06-22 11:06 +0800: `china-qijizhifeng/agentic-Harness-engineering`, `NousResearch/hermes-agent`, `stanford-iris-lab/meta-harness`, `rohitg00/agentmemory`, `pinchbench/skill`, `lsdefine/GenericAgent`, `openclaw/openclaw`, `obra/superpowers`, `EvoMap/awesome-agent-evolution`, `desplega-ai/agent-swarm`.
