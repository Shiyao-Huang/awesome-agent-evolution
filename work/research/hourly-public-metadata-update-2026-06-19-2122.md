# Hourly Public Metadata Update - 2026-06-19 21:22 +0800

## One Sentence

Refreshed the tracked GitHub anchors at 2026-06-19 21:22 +0800, propagated the fresher metadata through raw captures, classification, README, Mermaid, site reports, and index-facing surfaces, and removed duplicate front-page metadata blocks.
...
| `NousResearch/hermes-agent` | 197,356 | 34,899 | 12,076 | 7,262 | 14,943 | gh_graphql |
| `stanford-iris-lab/meta-harness` | 1,124 | 107 | 11 | 5 | 0 | gh_graphql |
| `rohitg00/agentmemory` | 23,418 | 1,921 | 462 | 150 | 159 | gh_graphql |
| `pinchbench/skill` | 1,242 | 140 | 383 | 21 | 0 | gh_graphql |
| `lsdefine/GenericAgent` | 12,960 | 1,499 | 875 | 86 | 61 | gh_graphql |
| `openclaw/openclaw` | 379,474 | 79,434 | 60,492 | 3,277 | 3,176 | gh_graphql |
| `obra/superpowers` | 232,966 | 20,687 | 609 | 125 | 144 | gh_graphql |
| `EvoMap/awesome-agent-evolution` | 142 | 20 | 65 | 6 | 1 | gh_graphql |
| `uid4oe/insight-swarm` | 0 | 0 | 25 | 0 | 0 | gh_graphql |
| `desplega-ai/agent-swarm` | 534 | 59 | 1,658 | 1 | 4 | gh_graphql |

## Delta Summary

- Real public deltas vs 2026-06-19 15:25 +0800: `NousResearch/hermes-agent`, `stanford-iris-lab/meta-harness`, `rohitg00/agentmemory`, `pinchbench/skill`, `lsdefine/GenericAgent`, `openclaw/openclaw`, `obra/superpowers`, `EvoMap/awesome-agent-evolution`, `desplega-ai/agent-swarm`.
