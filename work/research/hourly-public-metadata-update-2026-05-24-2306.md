...
- `HOME=/private/tmp/gitnexus-home gitnexus analyze --skip-git --index-only --name awesome-agent-evolution-hourly .`: passed, 9,371 nodes / 9,626 edges / 30 clusters / 13 flows; FTS degraded by extension download failure.
