# Hourly Public Metadata Update - 2026-07-05 01:38 +0800

## One Sentence

Refreshed the tracked GitHub anchors at 2026-07-05 01:38 +0800, propagated the fresher metadata through raw captures, classification, README, Mermaid, site reports, and index-facing surfaces, and removed duplicate front-page metadata blocks.
...
|---|---:|---:|---:|---:|---:|---|
| `china-qijizhifeng/agentic-Harness-engineering` | 684 | 75 | 46 | 2 | 0 | gh_graphql |
| `NousResearch/hermes-agent` | 209,108 | 38,140 | 14,393 | 8,568 | 17,135 | gh_graphql |
| `stanford-iris-lab/meta-harness` | 1,201 | 116 | 11 | 6 | 0 | gh_graphql |
| `rohitg00/agentmemory` | 24,550 | 2,021 | 463 | 172 | 187 | gh_graphql |
| `pinchbench/skill` | 1,260 | 144 | 383 | 21 | 0 | gh_graphql |
| `lsdefine/GenericAgent` | 13,283 | 1,535 | 895 | 94 | 71 | gh_graphql |
| `openclaw/openclaw` | 381,702 | 80,024 | 63,965 | 3,619 | 3,489 | gh_graphql |
| `obra/superpowers` | 246,063 | 21,819 | 628 | 149 | 173 | gh_graphql |
...
- Real public deltas vs 2026-07-04 19:38 +0800: `china-qijizhifeng/agentic-Harness-engineering`, `NousResearch/hermes-agent`, `rohitg00/agentmemory`, `lsdefine/GenericAgent`, `openclaw/openclaw`, `obra/superpowers`, `desplega-ai/agent-swarm`.
