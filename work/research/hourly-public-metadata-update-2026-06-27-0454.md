# Hourly Public Metadata Update - 2026-06-27 04:54 +0800

## One Sentence

Refreshed the tracked GitHub anchors at 2026-06-27 04:54 +0800, propagated the fresher metadata through raw captures, classification, README, Mermaid, site reports, and index-facing surfaces, and removed duplicate front-page metadata blocks.
...
| `NousResearch/hermes-agent` | 203,727 | 36,545 | 13,061 | 7,810 | 16,154 | gh_graphql |
| `stanford-iris-lab/meta-harness` | 1,162 | 113 | 11 | 5 | 0 | gh_graphql |
| `rohitg00/agentmemory` | 24,114 | 1,981 | 462 | 159 | 176 | gh_graphql |
| `pinchbench/skill` | 1,252 | 143 | 383 | 21 | 0 | gh_graphql |
| `lsdefine/GenericAgent` | 13,104 | 1,523 | 887 | 94 | 61 | gh_graphql |
| `openclaw/openclaw` | 380,601 | 79,731 | 62,353 | 3,359 | 3,353 | gh_graphql |
| `obra/superpowers` | 239,384 | 21,239 | 609 | 135 | 150 | gh_graphql |
| `EvoMap/awesome-agent-evolution` | 144 | 20 | 67 | 8 | 1 | gh_graphql |
| `uid4oe/insight-swarm` | 0 | 0 | 25 | 0 | 0 | gh_graphql |
| `desplega-ai/agent-swarm` | 550 | 60 | 1,686 | 1 | 4 | gh_graphql |

## Delta Summary

- Real public deltas vs 2026-06-26 22:53 +0800: `NousResearch/hermes-agent`, `rohitg00/agentmemory`, `lsdefine/GenericAgent`, `openclaw/openclaw`, `obra/superpowers`, `desplega-ai/agent-swarm`.
...
- Astro site build passed and produced 1000 static pages; existing TypeScript deprecation hints remain in `site/src/content.config.ts`.
...
- GitNexus analyze/query/detect-changes are blocked by LadybugDB storage-version mismatch (`database version 41`, current build `40`), so this run does not claim refreshed GitNexus relationship evidence.
- Public copy review gate was not rerun with 3-5 reader/editor agents plus 3 academic agents; this was a metadata-only freshness update, not a claim that public copy quality is complete.
