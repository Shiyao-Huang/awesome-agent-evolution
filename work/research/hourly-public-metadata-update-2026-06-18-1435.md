# Hourly Public Metadata Update - 2026-06-18 14:35 +0800

## One Sentence

Refreshed the tracked GitHub anchors at 2026-06-18 14:35 +0800, propagated the fresher metadata through raw captures, classification, README, Mermaid, site reports, and index-facing surfaces, and removed duplicate front-page metadata blocks.
...
|---|---:|---:|---:|---:|---:|---|
| `china-qijizhifeng/agentic-Harness-engineering` | 587 | 65 | 46 | 0 | 0 | gh_graphql |
| `NousResearch/hermes-agent` | 196,402 | 34,599 | 11,960 | 7,155 | 14,601 | gh_graphql |
| `stanford-iris-lab/meta-harness` | 1,114 | 106 | 11 | 5 | 0 | gh_graphql |
| `rohitg00/agentmemory` | 23,298 | 1,914 | 462 | 148 | 159 | gh_graphql |
| `pinchbench/skill` | 1,241 | 140 | 383 | 21 | 0 | gh_graphql |
| `lsdefine/GenericAgent` | 12,944 | 1,499 | 871 | 85 | 61 | gh_graphql |
| `openclaw/openclaw` | 379,285 | 79,403 | 59,995 | 3,313 | 3,190 | gh_graphql |
| `obra/superpowers` | 231,445 | 20,570 | 602 | 125 | 142 | gh_graphql |
| `EvoMap/awesome-agent-evolution` | 141 | 20 | 65 | 6 | 1 | gh_graphql |
| `uid4oe/insight-swarm` | 0 | 0 | 25 | 0 | 0 | gh_graphql |
| `desplega-ai/agent-swarm` | 533 | 59 | 1,648 | 1 | 6 | gh_graphql |

## Delta Summary

- Real public deltas vs 2026-06-18 08:33 +0800: `china-qijizhifeng/agentic-Harness-engineering`, `NousResearch/hermes-agent`, `stanford-iris-lab/meta-harness`, `rohitg00/agentmemory`, `pinchbench/skill`, `lsdefine/GenericAgent`, `openclaw/openclaw`, `obra/superpowers`, `desplega-ai/agent-swarm`.
