...
> Auto-maintained knowledge base. Every page has a link, summary, and source traceability.
> Pattern: Raw sources (immutable) → Wiki (LLM-maintained) → Schema (rules)
...
- [自博弈进化](concepts/self-play-evolution.md) — 生成者vs验证者对抗角色训练，SPIRAL/Debate/SPIN/Absolute Zero | Rank: A | 2026-05-26
- [架构搜索与自动化Agent设计](concepts/architecture-search.md) — ADAS/DGM/Gödel Agent/AlphaEvolve，archive多样性+stepping stones | Rank: A | 2026-05-26

## Sources

_Processed raw sources with extracted insights_
...
- [Resource Library Coverage Audit](synthesis/resource-library-coverage-audit.md) — 盘点 raw/processed/work/results/site/wiki 当前资产，解释 639 raw captures、232 analyzed reports、434 public reports、232 site records、801 project markdown files 等计数口径 | Rank: A | 2026-06-01
