...
1. [KNOWN] Governance counts currently include 653 raw GitHub captures, 653 classified repositories, 246 analyzed model-card reports, 95 strict evolution repositories, 202 broad evolution repositories, 201 raw paper files, 171 paper reviews, and 448 public project reports. Source: `docs/indexes/master-index.md`
...
| Count | Meaning |
|---:|---|
| 653 | Raw GitHub captures and classified repository rows. |
| 246 | Repositories in the analyzed model-card report funnel. |
| 448 | Public project report files under `site/public/reports/projects/`. |
| 239 | Current website project records in `site/src/data/projects.ts`. |
| 815 | Markdown files under `projects/`, including indexes/support/history. |
