...
Self-Corrective RAG with LangGraph - Agentic RAG Tutorial In this video you will learn how to perform "CRAG", self-corrective Retrieval Augmentation with LangGraph. You will learn how you can force an Agent to rewrite queries and check whether a document is suited to answer a question or not.
...
- blog_or_website: https://www.youtube.com/watch?v=uZoz3T3Z6-w
