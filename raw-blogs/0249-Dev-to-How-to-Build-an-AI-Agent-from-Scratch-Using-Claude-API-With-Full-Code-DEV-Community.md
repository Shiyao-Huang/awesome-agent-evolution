# How to Build an AI Agent from Scratch Using Claude API (With Full Code) - DEV Community
...
- blog_or_website: https://dev.to/dextralabs/how-to-build-an-ai-agent-from-scratch-using-claude-api-with-full-code-4b40
