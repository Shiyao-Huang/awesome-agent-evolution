...
本附录列出综述覆盖的全部 108 篇核心论文，按方法类别归类。每篇论文标注 arXiv 编号、年份和主要贡献。
...
\textbf{总计}：108 篇论文，覆盖 2022—2026 年 Agent Self-Evolution 领域主要工作。其中 2026 年论文 24 篇，安全/治理方向 3 篇（Misevolution, OEP, Capability Erosion），标志着该领域从性能优化向安全治理的重要转型。
