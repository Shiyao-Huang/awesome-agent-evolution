# 「AI自进化」新进展：自主构建、优化Agent Skills-36氪
...
**Source**: https://36kr.com/p/3728164375231362
...
[寻求报道](https://36kr.com/seek-report-new?t=1779339517556)
...
![](https://img.36krcdn.com/hsossms/20260318/v2_de2bb498ea8042e2a3b141d2c13b18d7@000000_oswg8897oswg542oswg178_img_000?x-oss-process=image/format,jpg/interlace,1)
...
![](https://img.36krcdn.com/hsossms/20260318/v2_68c67230cdef47c0bb44a050b93935e9@000000_oswg124133oswg743oswg991_img_000?x-oss-process=image/format,jpg/interlace,1)

图 | EvoSkill 循环概述。

这一机制的关键在于**底层模型保持冻结，仅 Skills 库随迭代更新**，从而将能力提升归因于 Skills 优化；**反馈历史记录每次提案及其结果**，帮助提议器避免重复无效方案，同时通过迭代使上下文信息逐步丰富；Skills **以文件夹形式存储**，包含元数据和指令，便于跨任务和跨模型复用。

![](https://img.36krcdn.com/hsossms/20260318/v2_15c6275e22ce4ba2b831372477740c29@000000_oswg140785oswg840oswg811_img_000?x-oss-process=image/format,jpg/interlace,1)
...
![](https://img.36krcdn.com/hsossms/20260318/v2_74358b7cffd7413e8e3fbcc2734dc21d@000000_oswg98482oswg896oswg520_img_000?x-oss-process=image/format,jpg/interlace,1)
...
从**理论层面**看，将优化对象从提示词或代码片段提升至 Skills 层面，有助于解耦能力与具体任务及模型的绑定。Skills 以结构化形式存储，包含明确的触发条件和执行流程，使其在不同场景下具备可迁移性。这一方向或将为 Agent 能力构建提供新的技术路径。

从**实践层面**看，自动化的 Skills 发现机制能够减轻手工编写 Skills 的人力负担。Skills 以独立文件夹形式存储，便于在不同 Agent 之间共享和复用，为构建开放 Skills 库奠定了基础，有助于推动 Agent 在协作场景下的能力互通。
...
本文来自微信公众号 [“学术头条”（ID：SciTouTiao）](https://mp.weixin.qq.com/s?__biz=Mzg4MDE3OTA5NA==&mid=2247603940&idx=1&sn=4512b44ac0a46bb00f8673eda990abbb&chksm=ce4d72af99235fd7ed48d13b4278ba76ecd4a7ee802c5e353a5bc48ebac0eb052e343fb850a4&scene=0&xtrack=1#rd)，作者：王跃然，36氪经授权发布。
...
[微  博](https://service.weibo.com/share/share.php?appkey=595885820&url=https://36kr.com/p/3728164375231362&title=「AI自进化」新进展：自主构建、优化Agent Skills)
...
[英伟达、阿里重估AI，把FLOPS“扔进垃圾堆”](https://36kr.com/p/3728086948494472)
