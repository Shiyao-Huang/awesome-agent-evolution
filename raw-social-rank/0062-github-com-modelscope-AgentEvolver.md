...
[Readme](https://github.com/modelscope/agentevolver#readme-ov-file)

### License

[Apache-2.0 license](https://github.com/modelscope/agentevolver#Apache-2.0-1-ov-file)

###         Uh oh! 

There was an error while loading. Please reload this page.

[Activity](https://github.com/modelscope/AgentEvolver/activity)

[Custom properties](https://github.com/modelscope/AgentEvolver/custom-properties)

### Stars

[1.4k
        stars](https://github.com/modelscope/AgentEvolver/stargazers)

### Watchers

[10
        watching](https://github.com/modelscope/AgentEvolver/watchers)

### Forks

[167
        forks](https://github.com/modelscope/AgentEvolver/forks)

[Report repository](https://github.com/contact/report-content?content_url=https%3A%2F%2Fgithub.com%2Fmodelscope%2FAgentEvolver&report=modelscope+%28user%29)

## [Releases](https://github.com/modelscope/AgentEvolver/releases)

No releases published

## [Packages
      0](https://github.com/orgs/modelscope/packages?repo_name=AgentEvolver)

###         Uh oh! 

There was an error while loading. Please reload this page.

## [Contributors](https://github.com/modelscope/AgentEvolver/graphs/contributors)
...
- [Python
          84.3%](https://github.com/modelscope/AgentEvolver/search?l=python)
- [JavaScript
          8.1%](https://github.com/modelscope/AgentEvolver/search?l=javascript)
- [HTML
          5.4%](https://github.com/modelscope/AgentEvolver/search?l=html)
- [CSS
          1.4%](https://github.com/modelscope/AgentEvolver/search?l=css)
- 
