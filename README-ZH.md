...
| 仓库 | 这轮补了什么 | 为什么重要 |
|---|---|---|
| [desplega-ai/agent-swarm](https://github.com/desplega-ai/agent-swarm) | 刷新 raw capture、project card、site public report 与分类元数据，统一到 2026-06-08 的公开 GitHub 页面更新信号。 | 它把 agent-swarm 从“多角色编排”推进到带 Docker worker、persistent identity、compounding memory 和 HITL workflow gate 的生产执行面。 |
