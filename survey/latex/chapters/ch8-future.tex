...
\begin{tikzpicture}[
  >=Stealth,
  phase/.style={
    rectangle, rounded corners=8pt, draw=#1, fill=white,
...
\begin{itemize}[nosep]
\item [MomTest-2026] \texttt{raw-social/mom-test/mom-test-findings-ZH.md}; \texttt{raw-social/mom-test/mom-test-findings-reddit-ZH.md}; \texttt{raw-social/mom-test/mom-test-findings-hn-ZH.md}; \texttt{raw-social/mom-test/mom-test-findings-x-ZH.md}. Mom Test 调研发现，2026-05-20/21。
