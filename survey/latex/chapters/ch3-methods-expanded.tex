...
\textbf{Agent Symbolic Learning}~\citep{agentsymbolic2024} maps backpropagation and gradient descent entirely into natural language space. Its core innovation is the \textbf{``language gradient''}---using text to describe how to improve each component:
...
\textbf{ADAS}~\citep{adas2024} (ICLR 2025, 414+ citations) defines the research area of ``automated agent system design'' and proposes the ``Meta Agent Search'' method:
...
\textbf{DGM}~\citep{dgm2025} combines Darwinian evolution with the self-referential properties of the G\"{o}del Machine, maintaining an open-ended archive of agent implementations:
