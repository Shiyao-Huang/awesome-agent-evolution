...
论文草稿、站点源码、脚本、调查图表、工程中间件归这里；可以迭代，但要有构建或验证入口。
...
| `site` | present | 2293 | 1081 | 0 | 66 MB |
| `survey` | present | 94 | 4 | 0 | 3.4 MB |
| `scripts` | present | 77 | 1 | 0 | 2.2 MB |
| `data-engine` | present | 495 | 20 | 0 | 29 MB |
| `work/research` | present | 101 | 2 | 0 | 2.4 MB |
| `work/wiki` | present | 85 | 6 | 0 | 587 KB |
...
- `site/.astro/collections/legacyResearchProjectReports.schema.json`
- `site/.astro/collections/paperCrossDomainReports.schema.json`
