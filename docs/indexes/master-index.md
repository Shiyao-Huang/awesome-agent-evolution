...
| [Work / 工作产物](./work-index.md) | 8/8 | 1574 | 286 | 0 | 44 MB | 论文草稿、站点源码、脚本、调查图表、工程中间件归这里；可以迭代，但要有构建或验证入口。 |
...
| [Ops / 管理与协作](./ops-index.md) | 9/9 | 32 | 5 | 0 | 823 KB | 项目管理、Agent 手册、云部署、索引、发布规范归这里；任何新长期规则都要能从根 README 找到。 |
