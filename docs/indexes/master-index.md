...
> Generated: 2026-06-27. Regenerate with `node scripts/generate_project_indexes.mjs`.
...
| [Work / 工作产物](./work-index.md) | 10/10 | 3286 | 1124 | 0 | 113 MB | 论文草稿、站点源码、脚本、调查图表、工程中间件归这里；可以迭代，但要有构建或验证入口。 |
