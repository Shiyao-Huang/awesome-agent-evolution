...
清洗、分类、交叉分析、深度项目卡、论文评审都归这里；内容必须能追溯到 raw 或外部 canonical source。

## Coverage

| Path | Status | Files | Directories | Skipped | Size |
|---|---|---:|---:|---:|---:|
| `analysis` | present | 14 | 1 | 0 | 1.0 MB |
| `research` | present | 116 | 4 | 0 | 1.9 MB |
| `projects` | present | 25219 | 2881 | 0 | 2.9 GB |
...
- `research/asset-processing-anysearch-supplement-2026-05-22.json`
- `research/asset-processing-anysearch-supplement-2026-05-22.md`
...
- `projects/01-opro-llm-as-optimizer.md`
- `projects/02-openelm-evolution-large-models.md`
- `projects/03-adas-automated-design-agentic-systems.md`
- `projects/04-funsearch-mathematical-discoveries.md`
- `projects/05-automl-agent-multi-agent.md`
- `projects/06-coml-mlcopilot.md`
