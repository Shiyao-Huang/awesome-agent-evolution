...
## 近期证据更新（2026-07-04 01:40 +0800）

本轮是新的 hourly public metadata 修复包，不再沿用 `2026-07-03 19:38 +0800` 的上一个 authenticated packet 作为唯一前台口径。抓取链路本身是可用的，但仍按“先重试 live GitHub API，失败时明确回退到上一个 authenticated packet”的规则更新，避免伪造 freshness。
...
| [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | Relative to the previous authenticated packet at 2026-07-03 19:38 +0800: stars 208,405 -> 208,568; forks 37,947 -> 37,970; issues 8,397 -> 8,449; PRs 16,814 -> 16,901; commits 14,313 -> 14,335; pushedAt 2026-07-03T11:08:51Z -> 2026-07-03T17:22:33Z; updatedAt 2026-07-03T11:33:32Z -> 2026-07-03T17:32:31Z. | 它回答“可用产品型 agent 长什么样”这个核心问题。 | [KNOWN] Authenticated GitHub API；未做本地运行/benchmark 复核。 |
| [stanford-iris-lab/meta-harness](https://github.com/stanford-iris-lab/meta-harness) | Relative to the previous authenticated packet at 2026-07-03 19:38 +0800: stars 1,194 -> 1,195; forks 115 -> 116; updatedAt 2026-07-03T07:52:21Z -> 2026-07-03T11:54:43Z. | 它是 outer-loop harness search 的最干净参考样本。 | [KNOWN] Authenticated GitHub API；未做本地运行/benchmark 复核。 |
| [rohitg00/agentmemory](https://github.com/rohitg00/agentmemory) | Relative to the previous authenticated packet at 2026-07-03 19:38 +0800: stars 24,493 -> 24,505; forks 2,015 -> 2,018; issues 168 -> 170; PRs 183 -> 185; updatedAt 2026-07-03T11:13:52Z -> 2026-07-03T17:21:20Z. | 它回答“长期记忆如何跨 Codex / Claude Code / Hermes / OpenClaw 持续积累”。 | [KNOWN] Authenticated GitHub API；未做本地运行/benchmark 复核。 |
| [pinchbench/skill](https://github.com/pinchbench/skill) | No public metadata delta was observed relative to the previous authenticated packet at 2026-07-03 19:38 +0800. | 它是 skill、memory、benchmark 三条线交叉的 evaluator substrate。 | [KNOWN] Authenticated GitHub API；未做本地运行/benchmark 复核。 |
| [lsdefine/GenericAgent](https://github.com/lsdefine/GenericAgent) | Relative to the previous authenticated packet at 2026-07-03 19:38 +0800: stars 13,276 -> 13,280; forks 1,533 -> 1,534; PRs 68 -> 69; updatedAt 2026-07-03T11:01:48Z -> 2026-07-03T17:18:51Z. | 它是“不要预装技能，而是让技能树生长”的 self-evolving 极简路线。 | [KNOWN] Authenticated GitHub API；未做本地运行/benchmark 复核。 |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Relative to the previous authenticated packet at 2026-07-03 19:38 +0800: stars 381,571 -> 381,585; forks 79,980 -> 79,999; issues 3,559 -> 3,563; PRs 3,405 -> 3,428; commits 63,563 -> 63,607; pushedAt 2026-07-03T11:38:28Z -> 2026-07-03T17:27:53Z; updatedAt 2026-07-03T11:38:07Z -> 2026-07-03T17:24:45Z. | 它是“agent 是否真的能给人用”的产品运行时锚点。 | [KNOWN] Authenticated GitHub API；未做本地运行/benchmark 复核。 |
| [obra/superpowers](https://github.com/obra/superpowers) | Relative to the previous authenticated packet at 2026-07-03 19:38 +0800: stars 245,100 -> 245,358; forks 21,718 -> 21,742; updatedAt 2026-07-03T11:38:33Z -> 2026-07-03T17:38:23Z. | 它把可复用技能和工程方法论这条线接进了自进化公开证据链。 | [KNOWN] Authenticated GitHub API；未做本地运行/benchmark 复核。 |
| [EvoMap/awesome-agent-evolution](https://github.com/EvoMap/awesome-agent-evolution) | No public metadata delta was observed relative to the previous authenticated packet at 2026-07-03 19:38 +0800. | 它帮助我们检查公开叙事是否比普通 awesome list 更有证据密度。 | [KNOWN] Authenticated GitHub API；未做本地运行/benchmark 复核。 |
| [uid4oe/insight-swarm](https://github.com/uid4oe/insight-swarm) | No public metadata delta was observed relative to the previous authenticated packet at 2026-07-03 19:38 +0800. | 它是“shared knowledge graph 替代中心 orchestrator”的 swarm 概念锚点。 | [KNOWN] Authenticated GitHub API；未做本地运行/benchmark 复核。 |
| [desplega-ai/agent-swarm](https://github.com/desplega-ai/agent-swarm) | Relative to the previous authenticated packet at 2026-07-03 19:38 +0800: commits 1,753 -> 1,755; pushedAt 2026-07-03T11:28:10Z -> 2026-07-03T14:48:15Z; updatedAt 2026-07-03T11:26:05Z -> 2026-07-03T14:47:52Z. | 它把用户要求的 agent-swarm 主线补进了公开证据链。 | [KNOWN] Authenticated GitHub API；未做本地运行/benchmark 复核。 |
