...
| [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | Relative to the previous authenticated packet at 2026-06-17 02:30 +0800: stars 195217 -> 195343; forks 34267 -> 34303; issues 6943 -> 6978; PRs 14188 -> 14228; commits 11838 -> 11856; pushedAt 2026-06-16T18:32:05Z -> 2026-06-17T00:21:01Z. | It answers the user’s product question: what a usable, growth-oriented agent runtime looks like in public. | [KNOWN] Authenticated GitHub API; no local runtime or benchmark rerun in this pass. |
| [stanford-iris-lab/meta-harness](https://github.com/stanford-iris-lab/meta-harness) | Relative to the previous authenticated packet at 2026-06-17 02:30 +0800: stars 1096 -> 1097. | It remains the cleanest public outer-loop harness-search reference. | [KNOWN] Authenticated GitHub API; no local runtime or benchmark rerun in this pass. |
| [rohitg00/agentmemory](https://github.com/rohitg00/agentmemory) | Relative to the previous authenticated packet at 2026-06-17 02:30 +0800: stars 23107 -> 23143; forks 1905 -> 1908. | It answers how long-horizon memory can accumulate across Codex, Claude Code, Hermes, and OpenClaw style runtimes. | [KNOWN] Authenticated GitHub API; no local runtime or benchmark rerun in this pass. |
| [pinchbench/skill](https://github.com/pinchbench/skill) | Relative to the previous authenticated packet at 2026-06-17 02:30 +0800: stars 1235 -> 1236. | It is where the skill, memory, and benchmark threads intersect as an evaluator substrate. | [KNOWN] Authenticated GitHub API; no local runtime or benchmark rerun in this pass. |
| [lsdefine/GenericAgent](https://github.com/lsdefine/GenericAgent) | Relative to the previous authenticated packet at 2026-06-17 02:30 +0800: stars 12917 -> 12921; forks 1495 -> 1496; PRs 62 -> 63. | It is still one of the clearest minimal “do not preload skills, evolve them” runtime samples. | [KNOWN] Authenticated GitHub API; no local runtime or benchmark rerun in this pass. |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Relative to the previous authenticated packet at 2026-06-17 02:30 +0800: stars 379032 -> 379052; forks 79322 -> 79325; issues 3270 -> 3264; PRs 2964 -> 2953; commits 59344 -> 59411; pushedAt 2026-06-16T18:29:30Z -> 2026-06-17T00:30:23Z. | It is the product-runtime anchor for asking whether agents are actually usable by people. | [KNOWN] Authenticated GitHub API; no local runtime or benchmark rerun in this pass. |
| [obra/superpowers](https://github.com/obra/superpowers) | Relative to the previous authenticated packet at 2026-06-17 02:30 +0800: stars 229721 -> 229865; forks 20425 -> 20442; issues 124 -> 122; PRs 159 -> 160; commits 598 -> 601; pushedAt 2026-06-16T17:43:09Z -> 2026-06-17T00:02:34Z. | It turns reusable skills and engineering methodology into a visible self-evolution infrastructure lane. | [KNOWN] Authenticated GitHub API; no local runtime or benchmark rerun in this pass. |
| [EvoMap/awesome-agent-evolution](https://github.com/EvoMap/awesome-agent-evolution) | No public metadata delta was observed relative to the previous authenticated packet at 2026-06-17 02:30 +0800. | It is the external mirror that tests whether our public packaging is more evidence-dense than a generic awesome list. | [KNOWN] Authenticated GitHub API; no local runtime or benchmark rerun in this pass. |
| [uid4oe/insight-swarm](https://github.com/uid4oe/insight-swarm) | No public metadata delta was observed relative to the previous authenticated packet at 2026-06-17 02:30 +0800. | It is a useful swarm concept anchor for graph-mediated multi-agent synthesis without a central orchestrator. | [KNOWN] Authenticated GitHub API; no local runtime or benchmark rerun in this pass. |
| [desplega-ai/agent-swarm](https://github.com/desplega-ai/agent-swarm) | Relative to the previous authenticated packet at 2026-06-17 02:30 +0800: stars 529 -> 530; PRs 4 -> 2; commits 1640 -> 1641; pushedAt 2026-06-16T15:09:15Z -> 2026-06-16T23:22:24Z. | It makes the user-requested agent-swarm lane explicit in the public evidence chain. | [KNOWN] Authenticated GitHub API; no local runtime or benchmark rerun in this pass. |

The GitNexus lane is available with a boundary: `node .gitnexus/run.cjs status` reports this repository as `stale`, while `node .gitnexus/run.cjs query -r awesome-evolution-workspace-cleanup "hourly public metadata graph.json repo-classification site/src/data/projects.ts"` still resolves the hourly metadata path back to historical script definitions such as `renderGraphJson`, `renderGraphMd`, and `renderRunNote`. This run therefore uses GitNexus for relationship evidence, but not as proof that the local index is fully current.
## Core Insight
