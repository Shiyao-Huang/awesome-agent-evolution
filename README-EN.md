...
## Recent Evidence Updates (2026-07-04 07:38 +0800)

This is a fresh hourly public metadata repair packet rather than another reuse of the previous authenticated packet from `2026-07-04 01:40 +0800`. The GitHub lane in this workspace is available again, but this run still follows a strict rule: retry live GitHub API fetches first, and only fall back to the previous authenticated packet when the live request fails, with the limit stated explicitly.

| Repository | This run's status | Why it matters | Evidence state |
|---|---|---|---|
| [china-qijizhifeng/agentic-Harness-engineering](https://github.com/china-qijizhifeng/agentic-Harness-engineering) | No public metadata delta was observed relative to the previous authenticated packet at 2026-07-04 01:40 +0800. | It is the clearest anchor for “the harness itself evolves.” | [KNOWN] Authenticated GitHub API; no local runtime or benchmark rerun in this pass. |
| [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | Relative to the previous authenticated packet at 2026-07-04 01:40 +0800: stars 208,568 -> 208,683; forks 37,970 -> 38,011; issues 8,449 -> 8,479; PRs 16,901 -> 16,949; commits 14,335 -> 14,351; pushedAt 2026-07-03T17:22:33Z -> 2026-07-03T20:44:02Z; updatedAt 2026-07-03T17:32:31Z -> 2026-07-03T23:32:39Z. | It answers the user’s product question: what a usable, growth-oriented agent runtime looks like in public. | [KNOWN] Authenticated GitHub API; no local runtime or benchmark rerun in this pass. |
| [stanford-iris-lab/meta-harness](https://github.com/stanford-iris-lab/meta-harness) | Relative to the previous authenticated packet at 2026-07-04 01:40 +0800: stars 1,195 -> 1,197; updatedAt 2026-07-03T11:54:43Z -> 2026-07-03T20:33:29Z. | It remains the cleanest public outer-loop harness-search reference. | [KNOWN] Authenticated GitHub API; no local runtime or benchmark rerun in this pass. |
| [rohitg00/agentmemory](https://github.com/rohitg00/agentmemory) | Relative to the previous authenticated packet at 2026-07-04 01:40 +0800: stars 24,505 -> 24,513; forks 2,018 -> 2,016; updatedAt 2026-07-03T17:21:20Z -> 2026-07-03T22:10:28Z. | It answers how long-horizon memory can accumulate across Codex, Claude Code, Hermes, and OpenClaw style runtimes. | [KNOWN] Authenticated GitHub API; no local runtime or benchmark rerun in this pass. |
| [pinchbench/skill](https://github.com/pinchbench/skill) | No public metadata delta was observed relative to the previous authenticated packet at 2026-07-04 01:40 +0800. | It is where the skill, memory, and benchmark threads intersect as an evaluator substrate. | [KNOWN] Authenticated GitHub API; no local runtime or benchmark rerun in this pass. |
| [lsdefine/GenericAgent](https://github.com/lsdefine/GenericAgent) | Relative to the previous authenticated packet at 2026-07-04 01:40 +0800: stars 13,280 -> 13,281; forks 1,534 -> 1,533; PRs 69 -> 70; updatedAt 2026-07-03T17:18:51Z -> 2026-07-03T22:24:03Z. | It is still one of the clearest minimal “do not preload skills, evolve them” runtime samples. | [KNOWN] Authenticated GitHub API; no local runtime or benchmark rerun in this pass. |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Relative to the previous authenticated packet at 2026-07-04 01:40 +0800: stars 381,585 -> 381,601; forks 79,999 -> 80,002; issues 3,563 -> 3,587; PRs 3,428 -> 3,435; commits 63,607 -> 63,702; pushedAt 2026-07-03T17:27:53Z -> 2026-07-03T23:38:05Z; updatedAt 2026-07-03T17:24:45Z -> 2026-07-03T23:38:16Z. | It is the product-runtime anchor for asking whether agents are actually usable by people. | [KNOWN] Authenticated GitHub API; no local runtime or benchmark rerun in this pass. |
| [obra/superpowers](https://github.com/obra/superpowers) | Relative to the previous authenticated packet at 2026-07-04 01:40 +0800: stars 245,358 -> 245,505; forks 21,742 -> 21,762; PRs 168 -> 169; updatedAt 2026-07-03T17:38:23Z -> 2026-07-03T23:30:25Z. | It turns reusable skills and engineering methodology into a visible self-evolution infrastructure lane. | [KNOWN] Authenticated GitHub API; no local runtime or benchmark rerun in this pass. |
| [EvoMap/awesome-agent-evolution](https://github.com/EvoMap/awesome-agent-evolution) | Relative to the previous authenticated packet at 2026-07-04 01:40 +0800: stars 162 -> 163; updatedAt 2026-07-02T17:13:34Z -> 2026-07-03T22:26:21Z. | It is the external mirror that tests whether our public packaging is more evidence-dense than a generic awesome list. | [KNOWN] Authenticated GitHub API; no local runtime or benchmark rerun in this pass. |
| [uid4oe/insight-swarm](https://github.com/uid4oe/insight-swarm) | No public metadata delta was observed relative to the previous authenticated packet at 2026-07-04 01:40 +0800. | It is a useful swarm concept anchor for graph-mediated multi-agent synthesis without a central orchestrator. | [KNOWN] Authenticated GitHub API; no local runtime or benchmark rerun in this pass. |
| [desplega-ai/agent-swarm](https://github.com/desplega-ai/agent-swarm) | No public metadata delta was observed relative to the previous authenticated packet at 2026-07-04 01:40 +0800. | It makes the user-requested agent-swarm lane explicit in the public evidence chain. | [KNOWN] Authenticated GitHub API; no local runtime or benchmark rerun in this pass. |
