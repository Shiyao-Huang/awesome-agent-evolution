...
|---|---|---|
| [sola-st/repairagent](https://github.com/sola-st/RepairAgent) | Refreshed the raw snapshot, project card, site-facing public report, and classification metadata from the public GitHub page observed on 2026-06-03. | It grounds coding-agent improvement in an explicit patch-and-test loop instead of relying on demo-style coding hype. |
| [zhang677/accelopt](https://github.com/zhang677/AccelOpt) | Refreshed the raw snapshot, project card, site-facing public report, and classification metadata from the public GitHub page observed on 2026-06-03. | It places self-improving agents under real hardware optimization pressure, which is closer to a high-value engineering loop than abstract prompt tinkering. |
| [hwfengcs/dm-code-agent](https://github.com/hwfengcs/DM-Code-Agent) | Refreshed the raw snapshot, project card, site-facing public report, and classification metadata from the public GitHub page observed on 2026-06-03. | It exposes the audit and replay boundary users actually care about, which makes coding-agent improvement claims easier to trust. |
| [rucbm/laser](https://github.com/RUCBM/LaSeR) | Refreshed the raw snapshot, project card, site-facing public report, and classification metadata from the public GitHub page observed on 2026-06-03. | It fills the gap between self-rewarding as a concept label and self-rewarding as a runnable training recipe. |
| [arthurmgraf/graphmind](https://github.com/arthurmgraf/graphmind) | Refreshed the raw snapshot, project card, site-facing public report, and classification metadata from the public GitHub page observed on 2026-06-03. | It connects knowledge graphs, agent runtime orchestration, and retrieval self-evaluation into one stack, which makes it a strong related sample for graph-native agents. |
