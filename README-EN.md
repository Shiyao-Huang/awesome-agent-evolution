...
- [KNOWN] Coverage boundaries, count meanings, and current gaps come from [analysis/resource-library-coverage-audit.md](analysis/resource-library-coverage-audit.md): 639 raw captures, 232 analyzed model-card reports, 434 public report files, 232 site project records, and 801 project markdown files describe different layers and should not be merged into one claim.
