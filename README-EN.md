...
|---|---:|---|---|
| GitHub corpus funnel | 618 raw captures / 618 classified / 211 model-card projects / 91 strict / 197 | `node scripts/analyze_github_project_data.mjs` | Strict and broad rising together means the core and infrastructure both expand; only broad rising may mean the concept is getting looser. |
...
| 3 | GitHub corpus funnel, classification axes, strict/broad evolution subsets | Read the processed structure first instead of blindly searching 618 raw captures. |
| 4 | Public model-card project groups | 211 site projects and 413 public report projects have already been processed by role, mechanism, evidence, and report entry point for direct comparison. |
...
| What is the GitHub corpus? | Currently 618 raw GitHub captures, 618 classified repositories, 211 site projects, 91 strict self-evolution repositories, and 197 broad related repositories, all unified by category, theme, function, and time slice. | [analysis/github-project-data-analysis.md](analysis/github-project-data-analysis.md), [repo classification](research/repo-classification.md) |
...
| Which projects were analyzed? | 618 repositories entered classification analysis; 211 entered site project data, and 413 public project report files serve publishable model-card/project-page material. | [projects/INDEX.md](projects/INDEX.md), [public reports](site/public/reports/projects/INDEX.md), [site/src/data/projects.ts](site/src/data/projects.ts) |
