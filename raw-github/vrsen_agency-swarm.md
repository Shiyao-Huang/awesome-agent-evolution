...
## GitHub - VRSEN/agency-swarm: Agency Swarm is a mature Python orchestration framework that layers role-aware communication flows, type-safe tools, thread persistence, and terminal/web demos on top of the OpenAI Agents SDK.
...
- Pull requests: 6
- License: MIT
- Primary language / stack signal: Python/OpenAI Agents SDK/Agency CLI/State Persistence
