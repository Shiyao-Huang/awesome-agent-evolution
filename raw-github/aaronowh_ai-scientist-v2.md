---
repo: aaronowh/ai-scientist-v2
url: https://github.com/aaronowh/ai-scientist-v2
content_timestamp: 2024-05-13
time_slice: 2024-Q2
...
## GitHub - AaronOwh/AI-Scientist-v2: The AI Scientist-v2: Workshop-Level Automated Scientific Discovery via Agentic Tree Search · GitHub

**Source**: https://github.com/aaronowh/ai-scientist-v2

---

[Skip to content](https://github.com/aaronowh/ai-scientist-v2#start-of-content)
...
[AaronOwh](https://github.com/AaronOwh)

/
**[AI-Scientist-v2](https://github.com/AaronOwh/AI-Scientist-v2)**

Public

       forked from [SakanaAI/AI-Scientist-v2](https://github.com/SakanaAI/AI-Scientist-v2)

- [Notifications](https://github.com/login?return_to=%2FAaronOwh%2FAI-Scientist-v2)You must be signed in to change notification settings
- [Fork
    0](https://github.com/login?return_to=%2FAaronOwh%2FAI-Scientist-v2)
- 
[Star
          0](https://github.com/login?return_to=%2FAaronOwh%2FAI-Scientist-v2)

[https://github.com/AaronOwh/AI-Scientist-v2](https://github.com/AaronOwh/AI-Scientist-v2)

[Branches](https://github.com/AaronOwh/AI-Scientist-v2/branches)[Tags](https://github.com/AaronOwh/AI-Scientist-v2/tags)

[https://github.com/AaronOwh/AI-Scientist-v2/branches](https://github.com/AaronOwh/AI-Scientist-v2/branches)[https://github.com/AaronOwh/AI-Scientist-v2/tags](https://github.com/AaronOwh/AI-Scientist-v2/tags)
...
|---|---|---|---|
| Latest commit History58 Commits58 Commits |  |  |  |
...
[https://github.com/aaronowh/ai-scientist-v2#----the-ai-scientist-v2-workshop-level-automated----scientific-discovery-via-agentic-tree-search--](https://github.com/aaronowh/ai-scientist-v2#----the-ai-scientist-v2-workshop-level-automated----scientific-discovery-via-agentic-tree-search--)
...
[https://github.com/aaronowh/ai-scientist-v2#table-of-contents](https://github.com/aaronowh/ai-scientist-v2#table-of-contents)

1. [Requirements](https://github.com/aaronowh/ai-scientist-v2#requirements)
  - [Installation](https://github.com/aaronowh/ai-scientist-v2#installation)
  - [Supported Models and API Keys](https://github.com/aaronowh/ai-scientist-v2#supported-models-and-api-keys)

2. [Generate Research Ideas](https://github.com/aaronowh/ai-scientist-v2#generate-research-ideas)
3. [Run AI Scientist-v2 Paper Generation Experiments](https://github.com/aaronowh/ai-scientist-v2#run-ai-scientist-v2-paper-generation-experiments)
4. [Citing The AI Scientist-v2](https://github.com/aaronowh/ai-scientist-v2#citing-the-ai-scientist-v2)
5. [Frequently Asked Questions](https://github.com/aaronowh/ai-scientist-v2#frequently-asked-questions)
6. [Acknowledgement](https://github.com/aaronowh/ai-scientist-v2#acknowledgement)

## Requirements

[https://github.com/aaronowh/ai-scientist-v2#requirements](https://github.com/aaronowh/ai-scientist-v2#requirements)

This code is designed to run on Linux with NVIDIA GPUs using CUDA and PyTorch.

### Installation

[https://github.com/aaronowh/ai-scientist-v2#installation](https://github.com/aaronowh/ai-scientist-v2#installation)
...
[https://github.com/aaronowh/ai-scientist-v2#supported-models-and-api-keys](https://github.com/aaronowh/ai-scientist-v2#supported-models-and-api-keys)

#### OpenAI Models

[https://github.com/aaronowh/ai-scientist-v2#openai-models](https://github.com/aaronowh/ai-scientist-v2#openai-models)

By default, the system uses the `OPENAI_API_KEY` environment variable for OpenAI models.

#### Gemini Models

[https://github.com/aaronowh/ai-scientist-v2#gemini-models](https://github.com/aaronowh/ai-scientist-v2#gemini-models)

By default, the system uses the `GEMINI_API_KEY` environment variable for Gemini models through OpenAI API.

#### Claude Models via AWS Bedrock

[https://github.com/aaronowh/ai-scientist-v2#claude-models-via-aws-bedrock](https://github.com/aaronowh/ai-scientist-v2#claude-models-via-aws-bedrock)
...
[https://github.com/aaronowh/ai-scientist-v2#semantic-scholar-api-literature-search](https://github.com/aaronowh/ai-scientist-v2#semantic-scholar-api-literature-search)
...
[https://github.com/aaronowh/ai-scientist-v2#setting-api-keys](https://github.com/aaronowh/ai-scientist-v2#setting-api-keys)
...
[https://github.com/aaronowh/ai-scientist-v2#generate-research-ideas](https://github.com/aaronowh/ai-scientist-v2#generate-research-ideas)
...
[https://github.com/aaronowh/ai-scientist-v2#run-ai-scientist-v2-paper-generation-experiments](https://github.com/aaronowh/ai-scientist-v2#run-ai-scientist-v2-paper-generation-experiments)
...
[https://github.com/aaronowh/ai-scientist-v2#citing-the-ai-scientist-v2](https://github.com/aaronowh/ai-scientist-v2#citing-the-ai-scientist-v2)
...
[https://github.com/aaronowh/ai-scientist-v2#frequently-asked-questions](https://github.com/aaronowh/ai-scientist-v2#frequently-asked-questions)
...
First, perform the [Generate Research Ideas](https://github.com/aaronowh/ai-scientist-v2#generate-research-ideas) step. Create a new Markdown file describing your desired subject field or topic, following the structure of the example `ai_scientist/ideas/i_cant_believe_its_not_better.md`. Run the `perform_ideation_temp_free.py` script with this file to generate a corresponding JSON idea file. Then, proceed to the [Run AI Scientist-v2 Paper Generation Experiments](https://github.com/aaronowh/ai-scientist-v2#run-ai-scientist-v2-paper-generation-experiments) step, using this JSON file with the `launch_scientist_bfts.py` script via the `--load_ideas` argument.
...
[https://github.com/aaronowh/ai-scientist-v2#acknowledgement](https://github.com/aaronowh/ai-scientist-v2#acknowledgement)
...
[https://github.com/aaronowh/ai-scientist-v2#star-history](https://github.com/aaronowh/ai-scientist-v2#star-history)

[https://star-history.com/#SakanaAI/AI-Scientist-v2&Date](https://star-history.com/#SakanaAI/AI-Scientist-v2&Date)

## ⚖️ License & Responsible Use

[https://github.com/aaronowh/ai-scientist-v2#%EF%B8%8F-license--responsible-use](https://github.com/aaronowh/ai-scientist-v2#%EF%B8%8F-license--responsible-use)
...
[Readme](https://github.com/aaronowh/ai-scientist-v2#readme-ov-file)

### License

[View license](https://github.com/aaronowh/ai-scientist-v2#License-1-ov-file)

###         Uh oh! 

There was an error while loading. Please reload this page.

[Activity](https://github.com/AaronOwh/AI-Scientist-v2/activity)

### Stars

[0
        stars](https://github.com/AaronOwh/AI-Scientist-v2/stargazers)

### Watchers

[0
        watching](https://github.com/AaronOwh/AI-Scientist-v2/watchers)

### Forks

[0
        forks](https://github.com/AaronOwh/AI-Scientist-v2/forks)

[Report repository](https://github.com/contact/report-content?content_url=https%3A%2F%2Fgithub.com%2FAaronOwh%2FAI-Scientist-v2&report=AaronOwh+%28user%29)

## [Releases](https://github.com/AaronOwh/AI-Scientist-v2/releases)

No releases published

## [Packages
      0](https://github.com/users/AaronOwh/packages?repo_name=AI-Scientist-v2)

###         Uh oh! 

There was an error while loading. Please reload this page.

## [Contributors](https://github.com/AaronOwh/AI-Scientist-v2/graphs/contributors)
