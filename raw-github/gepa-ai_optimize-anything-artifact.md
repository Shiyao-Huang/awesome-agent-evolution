---
repo: gepa-ai/optimize-anything-artifact
...
## GitHub - gepa-ai/optimize-anything-artifact · GitHub

**Source**: https://github.com/gepa-ai/optimize-anything-artifact

---

[Skip to content](https://github.com/gepa-ai/optimize-anything-artifact#start-of-content)
...
/
**[optimize-anything-artifact](https://github.com/gepa-ai/optimize-anything-artifact)**

Public

- [Notifications](https://github.com/login?return_to=%2Fgepa-ai%2Foptimize-anything-artifact)You must be signed in to change notification settings
- [Fork
    0](https://github.com/login?return_to=%2Fgepa-ai%2Foptimize-anything-artifact)
- 
[Star
          0](https://github.com/login?return_to=%2Fgepa-ai%2Foptimize-anything-artifact)

[https://github.com/gepa-ai/optimize-anything-artifact](https://github.com/gepa-ai/optimize-anything-artifact)

[Branches](https://github.com/gepa-ai/optimize-anything-artifact/branches)[Tags](https://github.com/gepa-ai/optimize-anything-artifact/tags)

[https://github.com/gepa-ai/optimize-anything-artifact/branches](https://github.com/gepa-ai/optimize-anything-artifact/branches)[https://github.com/gepa-ai/optimize-anything-artifact/tags](https://github.com/gepa-ai/optimize-anything-artifact/tags)
...
|---|---|---|---|
| Latest commit History794 Commits794 Commits |  |  |  |
| .github | .github |  |  |
| acm_cais_artifact_evaluation | acm_cais_artifact_evaluation |  |  |
| assets | assets |  |  |
| docs | docs |  |  |
| examples | examples |  |  |
| src/gepa | src/gepa |  |  |
...
[https://github.com/gepa-ai/optimize-anything-artifact#acm-cais26-artifact--gepa](https://github.com/gepa-ai/optimize-anything-artifact#acm-cais26-artifact--gepa)

This repository is the **reproducibility artifact** for the GEPA paper at ACM CAIS 2026.

> **Start here:**[acm_cais_artifact_evaluation/README.md](https://github.com/gepa-ai/optimize-anything-artifact/blob/main/acm_cais_artifact_evaluation/README.md). Each evaluation domain has its own subdirectory under `acm_cais_artifact_evaluation/domains/` with a runnable `main.py`, a per-domain README mapping the folder to a section of the paper, and the saved `GEPAState` checkpoint from the paper run.
...
[https://github.com/gepa-ai/optimize-anything-artifact#what-is-gepa](https://github.com/gepa-ai/optimize-anything-artifact#what-is-gepa)
...
[https://github.com/gepa-ai/optimize-anything-artifact#key-results](https://github.com/gepa-ai/optimize-anything-artifact#key-results)
...
[https://github.com/gepa-ai/optimize-anything-artifact#installation](https://github.com/gepa-ai/optimize-anything-artifact#installation)
...
[https://github.com/gepa-ai/optimize-anything-artifact#quick-start](https://github.com/gepa-ai/optimize-anything-artifact#quick-start)

### Simple Prompt Optimization

[https://github.com/gepa-ai/optimize-anything-artifact#simple-prompt-optimization](https://github.com/gepa-ai/optimize-anything-artifact#simple-prompt-optimization)
...
[https://github.com/gepa-ai/optimize-anything-artifact#with-dspy-recommended-for-ai-pipelines](https://github.com/gepa-ai/optimize-anything-artifact#with-dspy-recommended-for-ai-pipelines)
...
[https://github.com/gepa-ai/optimize-anything-artifact#optimize_anything-beyond-prompts](https://github.com/gepa-ai/optimize-anything-artifact#optimize_anything-beyond-prompts)
...
[https://github.com/gepa-ai/optimize-anything-artifact#how-it-works](https://github.com/gepa-ai/optimize-anything-artifact#how-it-works)
...
[https://github.com/gepa-ai/optimize-anything-artifact#adapters-plug-gepa-into-any-system](https://github.com/gepa-ai/optimize-anything-artifact#adapters-plug-gepa-into-any-system)

GEPA connects to your system via the [GEPAAdapter](https://github.com/gepa-ai/optimize-anything-artifact/blob/main/src/gepa/core/adapter.py) interface — implement `evaluate` and `make_reflective_dataset`, and GEPA handles the rest.
...
[https://github.com/gepa-ai/optimize-anything-artifact#integrations](https://github.com/gepa-ai/optimize-anything-artifact#integrations)
...
[https://github.com/gepa-ai/optimize-anything-artifact#example-optimized-prompts](https://github.com/gepa-ai/optimize-anything-artifact#example-optimized-prompts)
