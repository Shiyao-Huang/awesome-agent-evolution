...
## GitHub - haoxufd/OpenRLHF: An Easy-to-use, Scalable and High-performance RLHF Framework (70B+ PPO Full Tuning & Iterative DPO & LoRA & RingAttention & RFT) · GitHub

**Source**: https://github.com/haoxufd/openrlhf

---

[Skip to content](https://github.com/haoxufd/openrlhf#start-of-content)
...
[haoxufd](https://github.com/haoxufd)

/
**[OpenRLHF](https://github.com/haoxufd/OpenRLHF)**

Public

       forked from [OpenRLHF/OpenRLHF](https://github.com/OpenRLHF/OpenRLHF)

- [Notifications](https://github.com/login?return_to=%2Fhaoxufd%2FOpenRLHF)You must be signed in to change notification settings
- [Fork
    2](https://github.com/login?return_to=%2Fhaoxufd%2FOpenRLHF)
- 
[Star
          0](https://github.com/login?return_to=%2Fhaoxufd%2FOpenRLHF)

[https://github.com/haoxufd/OpenRLHF](https://github.com/haoxufd/OpenRLHF)

[Branches](https://github.com/haoxufd/OpenRLHF/branches)[Tags](https://github.com/haoxufd/OpenRLHF/tags)

[https://github.com/haoxufd/OpenRLHF/branches](https://github.com/haoxufd/OpenRLHF/branches)[https://github.com/haoxufd/OpenRLHF/tags](https://github.com/haoxufd/OpenRLHF/tags)
...
|---|---|---|---|
| Latest commit History1,461 Commits1,461 Commits |  |  |  |
...
[https://github.com/haoxufd/OpenRLHF/blob/main/docs/logo.png](https://github.com/haoxufd/OpenRLHF/blob/main/docs/logo.png)
...
[ English | [中文](https://github.com/haoxufd/OpenRLHF/blob/main/README_zh.md) | [日本語](https://github.com/haoxufd/OpenRLHF/blob/main/README_ja.md) ]
...
[https://github.com/haoxufd/openrlhf#-table-of-contents](https://github.com/haoxufd/openrlhf#-table-of-contents)

- [🗞️ News](https://github.com/haoxufd/openrlhf#news)
- [🏗️ Architecture Foundation](https://github.com/haoxufd/openrlhf#architecture-foundation-ray--vllm-distribution) - Ray + vLLM + DeepSpeed distributed infrastructure
- [🎯 Design Paradigm](https://github.com/haoxufd/openrlhf#design-paradigm-agent-based-execution) - Unified agent-based execution pipeline
- [🚀 RL Algorithms](https://github.com/haoxufd/openrlhf#state-of-the-art-rl-algorithms) - PPO, REINFORCE++, GRPO, RLOO
- [📋 Features Overview](https://github.com/haoxufd/openrlhf#comprehensive-features) - Complete RLHF pipeline capabilities
- [🎬 Quick Start](https://github.com/haoxufd/openrlhf#quick-start) - Installation and typical workflow
- [🎓 Training Guide](https://github.com/haoxufd/openrlhf#supervised-fine-tuning) - SFT, Reward Model, RL Training
- [🎯 Single-Turn Agent](https://github.com/haoxufd/openrlhf#single-turn-agent-reinforced-fine-tuning-with-custom-rewards) - Custom reward functions
- [🤖 Multi-Turn Agent](https://github.com/haoxufd/openrlhf#multi-turn-agent-complex-environment-interactions) - Complex environments
- [🔧 Advanced Topics](https://github.com/haoxufd/openrlhf#advanced-topics) - LoRA, performance tuning

---

## News

[https://github.com/haoxufd/openrlhf#news](https://github.com/haoxufd/openrlhf#news)
Show News
...
- [2025/5] OpenRLHF 0.8.0 supports async RLHF training via `--async_train` and async agent RLHF via `--agent_func_path`. See [train_reinforce_baseline_ray_agent_async.sh](https://github.com/haoxufd/OpenRLHF/blob/main/examples/scripts/train_reinforce_baseline_ray_agent_async.sh) for a runnable example.
...
[https://github.com/haoxufd/openrlhf#%EF%B8%8F-architecture-foundation-ray--vllm-distribution](https://github.com/haoxufd/openrlhf#%EF%B8%8F-architecture-foundation-ray--vllm-distribution)
...
[https://github.com/haoxufd/OpenRLHF/blob/main/docs/openrlhf_architecture.svg](https://github.com/haoxufd/OpenRLHF/blob/main/docs/openrlhf_architecture.svg)

### Core Infrastructure Components

[https://github.com/haoxufd/openrlhf#core-infrastructure-components](https://github.com/haoxufd/openrlhf#core-infrastructure-components)
...
[https://github.com/haoxufd/openrlhf#-design-paradigm-agent-based-execution](https://github.com/haoxufd/openrlhf#-design-paradigm-agent-based-execution)
...
[https://github.com/haoxufd/openrlhf#why-agent-based](https://github.com/haoxufd/openrlhf#why-agent-based)
...
[https://github.com/haoxufd/openrlhf#agent-architecture](https://github.com/haoxufd/openrlhf#agent-architecture)
...
[https://github.com/haoxufd/openrlhf#core-design-principles](https://github.com/haoxufd/openrlhf#core-design-principles)
...
[https://github.com/haoxufd/openrlhf#two-execution-modes-orthogonal-to-rl-algorithms](https://github.com/haoxufd/openrlhf#two-execution-modes-orthogonal-to-rl-algorithms)
...
[https://github.com/haoxufd/openrlhf#-state-of-the-art-rl-algorithms](https://github.com/haoxufd/openrlhf#-state-of-the-art-rl-algorithms)
...
[https://github.com/haoxufd/openrlhf#-comprehensive-features](https://github.com/haoxufd/openrlhf#-comprehensive-features)

OpenRLHF provides a complete RLHF pipeline with agent-based flexibility:

### 🎯 Agent-Based RL Training (Core Innovation)

[https://github.com/haoxufd/openrlhf#-agent-based-rl-training-core-innovation](https://github.com/haoxufd/openrlhf#-agent-based-rl-training-core-innovation)
Show agent-based RL training details

**Single-Turn Mode** (Default - 99% of use cases)

- One-shot generation per prompt
- Works with all RL algorithms: [PPO](https://github.com/haoxufd/OpenRLHF/blob/main/examples/scripts/train_ppo_ray_hybrid_engine.sh), [REINFORCE++/baseline/GRPO/RLOO](https://github.com/haoxufd/OpenRLHF/blob/main/examples/scripts/train_reinforce_baseline_hybrid_engine.sh)
- [Custom reward functions](https://github.com/haoxufd/OpenRLHF/blob/main/examples/scripts/train_ppo_with_reward_fn.sh) (`--remote_rm_url`)
- [Hybrid Engine](https://github.com/haoxufd/OpenRLHF/blob/main/examples/scripts/train_ppo_ray_hybrid_engine.sh) for maximum GPU utilization

**Multi-Turn Mode** (Advanced - Interactive tasks)

- Multi-step interactions with environment feedback
- Works with all RL algorithms
- [Custom agent functions](https://github.com/haoxufd/OpenRLHF/blob/main/examples/scripts/train_reinforce_baseline_ray_agent_async.sh) (`--agent_func_path`)
...
- Async pipeline (`--async_train`) for higher throughput: [train_reinforce_baseline_ray_agent_async.sh](https://github.com/haoxufd/OpenRLHF/blob/main/examples/scripts/train_reinforce_baseline_ray_agent_async.sh)

### 🎓 Supervised Training & Preference Learning

[https://github.com/haoxufd/openrlhf#-supervised-training--preference-learning](https://github.com/haoxufd/openrlhf#-supervised-training--preference-learning)
...
| KTO | train_kto_llama.sh | Kahneman-Tversky optimization |
| Iterative DPO | train_iterative_dpo.sh | Online preference learning |
| Reward Model | train_rm.sh | Train reward models |
| Process RM | train_prm_mistral.sh | Step-by-step reward models |
| Rejection Sampling | train_rejection_sampling_llama.sh | Best-of-N sampling |
| Conditional SFT | train_conditional.sh | Quality-conditioned training |
| Distillation | train_knowledge_distillation.sh | Knowledge transfer |

### ⚡ Advanced Capabilities

[https://github.com/haoxufd/openrlhf#-advanced-capabilities](https://github.com/haoxufd/openrlhf#-advanced-capabilities)
...
- DAPO [dynamic filtering](https://github.com/haoxufd/OpenRLHF/blob/main/examples/scripts/train_dapo_ray_hybrid_engine.sh) (`--dynamic_filtering`) 
...
- [RingAttention](https://github.com/haoxufd/OpenRLHF/blob/main/examples/test_scripts/train_dpo_ring_llama.sh) for long context (`--ring_attn_size`)
- Multi-node training with [SLURM](https://github.com/haoxufd/OpenRLHF/blob/main/examples/scripts/train_ppo_ray_slurm.sh)

**Model Support**

- [LoRA/QLoRA](https://github.com/haoxufd/OpenRLHF/blob/main/examples/scripts/train_sft_mixtral_lora.sh) (`--lora_rank`, `--load_in_4bit`)
- [Mixture of Experts (MoE)](https://github.com/haoxufd/OpenRLHF/blob/main/examples/test_scripts/train_sft_moe.sh) (`--aux_loss_coef`)
...
[https://github.com/haoxufd/openrlhf#-quick-start](https://github.com/haoxufd/openrlhf#-quick-start)

### Installation

[https://github.com/haoxufd/openrlhf#installation](https://github.com/haoxufd/openrlhf#installation)
...
pip install openrlhf[vllm]              # + vLLM 0.13.0 (recommended)
...
We recommend **vLLM 0.13.0+** for best performance. See [Dockerfiles](https://github.com/haoxufd/OpenRLHF/blob/main/dockerfile) and [Nvidia-Docker Install Script](https://github.com/haoxufd/OpenRLHF/blob/main/examples/scripts/nvidia_docker_install.sh).

### Prepare Datasets

[https://github.com/haoxufd/openrlhf#prepare-datasets](https://github.com/haoxufd/openrlhf#prepare-datasets)
...
[https://github.com/haoxufd/openrlhf#supervised-fine-tuning](https://github.com/haoxufd/openrlhf#supervised-fine-tuning)
...
Then you can use the startup scripts we provide in the [examples/scripts](https://github.com/haoxufd/OpenRLHF/blob/main/examples/scripts) directory, or start the training using the following commands.
