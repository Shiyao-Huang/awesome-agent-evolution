...
claimBoundary: "This list is a reading path across project evidence, not a project ranking. Counts trace to the dated repository index and should be rechecked before citation."
---

## 为什么关注这些项目

Self Evolve 项目索引已收录 682 个 GitHub 仓库，本文选取 10 个覆盖不同机制的开源项目。它们不是最终排名，而是一条阅读路径：从进化搜索循环、评估器/打分器、反思记忆到智能体编排，帮助读者判断“这个系统到底如何改进自己”。
...
Self Evolve 项目索引（agent-evolution.com）持续收录新项目。当前公开索引已覆盖 290 份项目/模型卡分析，并把 raw collection、processed analysis、project reports 和 public results 分层治理；读者应把本文当作入门路线，而不是仓库质量排名。
