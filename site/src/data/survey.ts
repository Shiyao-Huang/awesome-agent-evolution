...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    keyTakeaway: 'Skill libraries can create compound returns, but stale or mis-retrieved skills can also pollute future behavior.',
  ...
  },
  {
    ...
    keyTakeaway: 'Language can act as a medium of self-improvement when reflections are scoped, retrievable, and checked against task outcomes.',
...
export const painPoints: PainPoint[] = [
  {
    ...
    surveyEvidence: '97 public discussion signals across Reddit, HN, and X/Twitter point to reliability ceilings as a recurring blocker.',
  },
  {
  ...
  },
  {
    ...
    surveyEvidence: 'GitHub project analysis suggests framework readiness remains uneven; the framework score is heuristic, not benchmark-rerun evidence.',
  },
  {
