...
export const projects: Project[] = [
  ...
  },
  {
    ...
    "stack": ["Python", "FastAPI", "Docker", "Milvus", "Elasticsearch"],
    "category": "自进化 Agent 记忆系统",
    "lastPushed": "2026-01-01T00:00:00Z",
    "localPath": "repos/evermind_ai__everos",
    "status": "verified",
    "tags": ["反思记忆", "智能体编排", "长期记忆", "自进化Agent"]
  },
  {
    "name": "OpenTreeSearch",
  ...
  // ── 多 Agent 协作 + 开源平台 + Agent 评测 (Reports 43-72, Builder-4 Round 4) ──
  ,{
    "name": "future-agi",
  ...
  ,{
    ...
    "stack": ["TypeScript", "Next.js", "Python", "FastAPI", "MySQL"],
    "category": "自主 Agent 平台",
    "lastPushed": "2025-08-01T00:00:00Z",
    "localPath": "repos/reworkd__agentgpt",
    "status": "candidate",
    "tags": ["自主 Agent", "任务分解", "Web UI"]
  }
  ,{
    "name": "agenta",
  ...
  ,{
    ...
    "stack": ["Python", "TypeScript", "gRPC", "Firecracker"],
    "category": "代码执行沙箱",
  ...
  ,{
    ...
    "stack": ["Python", "Svelte", "Docker", "Ollama"],
    "category": "自托管 AI 平台",
    "lastPushed": "2026-05-22T00:00:00Z",
  ...
  ,{
    ...
    "stack": ["Python", "VirtualBox", "Docker"],
    "category": "Agent 评测基准",
  ...
  ,{
    ...
    "stack": ["Python", "FastAPI", "Qdrant", "Docker"],
    "category": "AI 聊天框架",
    "lastPushed": "2026-05-10T00:00:00Z",
  ...
  ,{
    ...
    "stack": ["Python", "HuggingFace", "Transformers"],
    "category": "Agent 框架",
    "lastPushed": "2026-05-20T00:00:00Z",
    "localPath": "repos/huggingface__smolagents",
    "status": "candidate",
    "tags": ["轻量 Agent", "HuggingFace", "工具调用"]
  }
  ,{
    "name": "bisheng",
