...
EverOS 的核心组件 EverCore 是一个受生物印刻 (biological imprinting) 启发的自组织记忆操作系统，能够从对话中自动提取、结构化和检索长期知识。EverCore 在 LoCoMo 基准上达到 93.05%，在 LongMemEval 上达到 83.00%，代表了当前长期对话记忆的最佳水平。
