...
The raw capture now reflects a GitHub metadata packet observed on 2026-07-04: 1,197 stars, 116 forks, 11 commits, 6 open issues, and 0 open pull requests. This packet is fresher than the previous authenticated packet at 2026-07-04 01:40 +0800 where a delta was observed. This run did not execute the repository locally, validate workflows end to end, or independently rerun benchmark claims. Product, memory, benchmark, and automation claims therefore remain repository-scoped unless separately tested.
