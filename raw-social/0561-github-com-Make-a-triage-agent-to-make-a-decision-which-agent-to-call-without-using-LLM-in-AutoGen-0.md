# Make a triage agent to make a decision which agent to call without using LLM in AutoGen 0.4 · microsoft/autogen · Discussion #5467 · GitHub
...
- time_slice: unknown
- Query: reddit "AutoGen" "multi-agent"
