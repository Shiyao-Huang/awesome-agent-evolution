# Self-Improving AI Agents: A Scientific Study | Articles | o-mega
...
**Source**: https://o-mega.ai/articles/self-improving-ai-agents-a-scientific-study

---

Self-Improving AI Agents: A Scientific Study | Articles | o-mega

![Yuma Heymans](https://o-mega.ai/_next/image?url=%2Fimages%2Fyuma-heymans.png&w=96&q=75)

Yuma Heymans

[https://x.com/yumahey](https://x.com/yumahey)[https://linkedin.com/in/yumaheymans](https://linkedin.com/in/yumaheymans)
...
The system is called the **Darwin Godel Machine**. It maintains a growing archive of coding agents. It samples agents from the archive, mutates them using an LLM, tests the mutants against real-world software engineering tasks, and archives the ones that perform better. Over hundreds of generations, it discovered patch validation steps, enhanced file-viewing mechanisms, multi-solution ranking, and historical tracking of failed attempts. None of these were programmed by humans. The agent invented them - [Sakana AI](https://sakana.ai/dgm/).

This is not an isolated result. In March 2026, **MiniMax** (a Chinese AI company) released M2.7, a model that autonomously ran over **100 rounds of scaffold optimization** without human intervention, achieving a **30% performance improvement** - [VentureBeat](https://venturebeat.com/technology/new-minimax-m2-7-proprietary-ai-model-is-self-evolving-and-can-perform-30-50). Andrej Karpathy's **AutoResearch** ran 700 experiments in two days, discovering 20 optimizations that yielded an **11% training speedup** on a small language model - [Fortune](https://fortune.com/2026/03/17/andrej-karpathy-loop-autonomous-ai-agents-future/). Google DeepMind's **AlphaEvolve** continuously recovers **0.7% of Google's worldwide compute resources** through evolutionary code optimization - [Google DeepMind](https://deepmind.google/blog/alphaevolve-a-gemini-powered-coding-agent-for-designing-advanced-algorithms/). And Anthropic's CEO confirmed that **70-90% of shipped code** at the company is now written by Claude, with at least one engineer reporting **100% AI-authored** updates in December 2025 - [Fortune](https://fortune.com/2026/01/29/100-percent-of-code-at-anthropic-and-openai-is-now-ai-written-boris-cherny-roon/).
...
A companion survey, "A Comprehensive Survey of Self-Evolving AI Agents" (arXiv 2508.07407), bridges the gap between foundation models and lifelong agentic systems. It maintains a companion repository (EvoAgentX/Awesome-Self-Evolving-Agents) that tracks the rapidly expanding literature - [GitHub](https://github.com/EvoAgentX/Awesome-Self-Evolving-Agents). The fact that two major surveys appeared in 2025, both attempting to taxonomize a field that barely existed two years earlier, is itself evidence of how fast the research frontier is moving.
...
The idea of machines that improve themselves is older than digital computers. But the practical history begins in 1976 with a program called **Eurisko**, built by Doug Lenat at Carnegie Mellon University. Eurisko was a system of self-modifying heuristics: rules that suggested new rules, and meta-rules that could modify any rule, including themselves - [Wikipedia](https://en.wikipedia.org/wiki/Eurisko).

Eurisko's most famous achievement was winning the US **Traveller TCS** national championship in 1981 by discovering optimal fleet designs that human players had never considered. It won again in 1982 by discovering a meta-strategy: it could deliberately destroy its own ships to maintain a strategic advantage. The organizers changed the rules to prevent this. Lenat observed that Eurisko's mutations were "highly non-random" because the system could code for **meta-heuristic rules** that enabled increasingly targeted variation - [LessWrong](https://www.lesswrong.com/w/eurisko).
...
The comprehensive survey published in 2025 proposes a framework that organizes the rapidly expanding field into three questions: what changes, when it changes, and how the change is produced - [arXiv](https://arxiv.org/abs/2507.21046). Understanding this taxonomy is essential for evaluating any self-improving system, because the answers to these three questions determine the ceiling, speed, and safety profile of the improvement.
...
The third mechanism addresses a different dimension of self-improvement: not performance on tasks but alignment with human values. **Constitutional AI** (Anthropic) demonstrates that an AI system can improve its own harmlessness without human labels, using a set of written principles (a "constitution") as the self-improvement objective - [Anthropic](https://www.anthropic.com/research/constitutional-ai-harmlessness-from-ai-feedback).
...
The concept draws directly from biological immune systems. The April 2025 paper "Self-Healing Software Systems: Lessons from Nature, Powered by AI" proposes a framework with three components: **observability tools as sensory inputs** (the system's ability to perceive its own state), **AI models as a cognitive core** for diagnosis and repair (the system's ability to reason about failures), and **healing agents** that apply targeted code and test modifications (the system's ability to act on its diagnosis) - [arXiv](https://arxiv.org/abs/2504.20093).

The practical impact is already measurable. AI-powered test automation systems eliminate **up to 95% of test maintenance** by autonomously adapting tests when the application under test changes - [CloudQA](https://cloudqa.io/how-ai-self-healing-frameworks-are-eliminating-api-test-maintenance/). Organizations using self-healing AI report **up to 60% reduction in release cycles**. Autonomous agents now generate self-correcting pull requests that integrate directly into CI/CD pipelines - [Digital.ai](https://digital.ai/catalyst-blog/self-healing-software-development/).
...
**Evidence for compounding:** SWE-bench Verified scores progressed from **4.4%** (2023) to approximately **80%** (2026 top systems). That is an 18x improvement in three years on a fixed benchmark measuring real-world software engineering capability - [Epoch AI](https://epoch.ai/benchmarks/swe-bench-verified).
...
**Leopold Aschenbrenner's** analysis in "Situational Awareness" projects that hundreds of millions of AGIs could compress a decade of algorithmic progress into one year or less, with fully automated AI researchers emerging by 2027-2028 - [Situational Awareness](https://situational-awareness.ai/). **Dario Amodei** (Anthropic) estimates that AI could compress 50-100 years of biological research progress into 5-10 years. These projections assume that improvement compounds across domain boundaries, which remains unproven.
