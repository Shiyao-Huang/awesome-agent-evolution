# [MODEL] Subagent findings relayed to user without verification — poor prompt context causes false positives and token waste · Issue #43537 · anthropics/claude-code
...
- time_slice: unknown
- Query: reddit "AI coding agents" "issues"
