# Agent created with `create_react_agent` does not retain private state properties passed from earlier nodes in the graph, causing validation error · Issue #6224 · langchain-ai/langgraph
