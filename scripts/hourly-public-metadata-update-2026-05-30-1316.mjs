...
const runAt = '2026-05-30T13:16:52+08:00';
const runDate = '2026-05-30';
const runDisplay = '2026-05-30 13:16 +0800';
const runNote = 'work/research/hourly-public-metadata-update-2026-05-30-1316.md';
...
const repos = [
  {
    ...
    "rawFile": "raw-github/dotnet_skills.md",
    ...
    "base_theme": "skill",
    "stack": "Markdown/.NET C#/Agent Skills Packs and Scoring Dashboard",
    "language": "Markdown",
    "license": "MIT",
    "stars": 3200,
    "forks": 236,
    ...
    "evidence": "web-observed GitHub page showed about 3.2k stars, 236 forks, 463 commits, MIT license, and README positioning as the official .NET agent skills repository.",
    "excerpts": [
      "README headline frames this as the official .NET skills repository.",
      "Repository includes docs, scorecards, and integrations with multiple agent runtimes.",
      "Public page snapshot showed about 3.2k stars, 236 forks, and 463 commits.",
  ...
  },
  {
    ...
    "evidence": "web-observed GitHub page showed 9 stars, 1 fork, 17 commits, BSD-3-Clause license, and README focus on agent skill packs for practical coding workflows.",
    "excerpts": [
      "README introduces the repository as a collection of practical agent skills.",
      "Repository tree includes skill definitions and integration notes for coding-agent runtimes.",
      "Public page snapshot showed 9 stars, 1 fork, and 17 commits.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/block_agent-skills.md",
    ...
    "base_theme": "skill",
    "stack": "Markdown/Agent Skill Playbooks/Claude and Codex",
    "language": "Markdown",
    "license": "Apache-2.0",
    "stars": 96,
    "forks": 25,
    ...
    "evidence": "web-observed GitHub page showed 96 stars, 25 forks, 60 commits, Apache-2.0 license, and repository messaging around enterprise-ready agent skills.",
    "excerpts": [
      "README labels this repository as a set of coding-agent skills and workflows.",
      "Repository includes curated playbooks for repeatable engineering tasks.",
      "Public page snapshot showed 96 stars, 25 forks, and 60 commits.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/corbell-ai_evalmonkey.md",
    ...
    "stack": "Python/LLM Evaluation Harness/Continuous Regression Tests",
    "language": "Python",
    "license": "Apache-2.0",
    "stars": 36,
    "forks": 4,
    ...
    "evidence": "web-observed GitHub page showed 36 stars, 4 forks, 30 commits, Apache-2.0 license, and README focus on evaluating LLM agent performance.",
    "excerpts": [
      "README positions EvalMonkey as a framework for evaluating AI agent performance.",
      "Repository exposes benchmark and harness components for repeatable agent checks.",
      "Public page snapshot showed 36 stars, 4 forks, and 30 commits.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "evidence": "web-observed GitHub page showed 54 stars, 3 forks, 15 commits, Apache-2.0 license, and README framing around benchmark-heavy agent context evaluation.",
    "excerpts": [
      "README headline presents AEC-Bench as a benchmark for agentic context engineering.",
      "Repository includes benchmark assets and evaluation-oriented project structure.",
      "Public page snapshot showed 54 stars, 3 forks, and 15 commits.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/google_ax.md",
    ...
    "stack": "Go/TypeScript/Agent Runtime and Context Engineering",
    "language": "Go",
    "license": "Apache-2.0",
    "stars": 1300,
    "forks": 70,
    ...
    "evidence": "web-observed GitHub page showed about 1.3k stars, 70 forks, 454 commits, Apache-2.0 license, and README framing around production AI agent infrastructure.",
    "excerpts": [
      "README positions AX as an open source platform for building and deploying production AI agents.",
      "Repository structure combines runtime modules, docs, and integration surfaces.",
      "Public page snapshot showed about 1.3k stars, 70 forks, and 454 commits.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  }
];
