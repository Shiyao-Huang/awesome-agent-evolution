...
const runAt = '2026-06-02T13:53:05+08:00';
const runDate = '2026-06-02';
const runDisplay = '2026-06-02 13:53 +0800';
const runNote = 'work/research/hourly-public-metadata-update-2026-06-02-1353.md';
...
const repos = [
  {
    ...
    rawFile: 'raw-github/plaited_agent-eval-harness.md',
    ...
    stack: 'TypeScript/Bun/CLI Agent Eval Harness',
    language: 'TypeScript',
    license: 'ISC',
    stars: 3,
    forks: 1,
    ...
    tags: ['evaluation', 'harness', 'cli-agent', 'schema', 'benchmark'],
    ...
    evidence: 'web-observed GitHub page showed 3 stars, 1 fork, 73 commits, ISC license, and explicit run/grade/compare/calibrate eval pipeline framing.',
    excerpts: [
      'README calls this a general-purpose eval harness for CLI agents with one entrypoint.',
      'Public metadata snapshot showed 3 stars, 1 fork, and 73 commits.',
      'README documents run, grade, compare, and calibrate modes for trial evidence.',
  ...
  },
  {
    ...
    rawFile: 'raw-github/najeed_ai-agent-eval-harness.md',
    ...
    function_tag: 'benchmark-suite',
    base_theme: 'evaluation',
    stack: 'Python/Docker/Enterprise Agent Eval Harness',
    language: 'Python',
    license: 'Apache-2.0',
    stars: 28,
    forks: 6,
    ...
    tags: ['evaluation', 'verification', 'enterprise', 'multi-agent', 'harness'],
    ...
    evidence: 'web-observed GitHub page showed 28 stars, 6 forks, 252 commits, Apache-2.0 license, and MultiAgentEval reliability-framework positioning.',
    excerpts: [
      'README labels the project MultiAgentEval and an enterprise-grade reliability framework for AI agents.',
      'Public metadata snapshot showed 28 stars, 6 forks, and 252 commits.',
      'Repository tree exposes benchmarks, eval_runner, reports, scenarios, schemas, and visual debugger surfaces.',
      'Counts were taken from the public GitHub page without authenticated API claims.'
    ]
  },
  {
    ...
    tags: ['benchmark', 'continual-learning', 'stateful', 'agent', 'crm-workflow'],
    ...
    evidence: 'web-observed GitHub page showed 19 stars, 3 forks, 50 commits, Apache-2.0 license, and explicit continual-learning benchmark framing for stateful environments.',
    excerpts: [
  ...
  },
  {
    ...
    rawFile: 'raw-github/versatly_clawvault.md',
    ...
    base_theme: 'memory',
    stack: 'TypeScript/Node/OpenClaw Memory Runtime',
    language: 'TypeScript',
    license: 'MIT',
    stars: 646,
    forks: 62,
    ...
    tags: ['memory', 'runtime', 'openclaw', 'persistent-context', 'agent'],
    ...
    evidence: 'web-observed GitHub page showed 646 stars, 62 forks, 689 commits, MIT license, benchmark and eval directories, and OpenClaw-oriented persistent-memory framing with a deprecation boundary for fresh deployments.',
    excerpts: [
      'README labels ClawVault as persistent memory for AI agents.',
      'Public metadata snapshot showed 646 stars, 62 forks, and 689 commits.',
      'Repository tree exposes benchmarks, eval, observer-bench examples, and OpenClaw plugin/runtime surfaces.',
      'README now marks the package deprecated for new OpenClaw deployments, which is an important trust-boundary signal.'
    ]
  }
];
...
function updateProjectsData() {
  ...
  source = addToGroup(source, 'Agent 评测基准', repos.filter((repo) => repo.base_theme === 'evaluation').map((repo) => repo.repo));
  write(file, source);
}
...
function updateReadmes() {
  ...
  for (const file of ['README.md', 'README-ZH.md', 'README-EN.md']) {
    ...
    const axisCategory = en ? `| Collection category | ${categoryLine} | Repository shape: frameworks still dominate, while benchmark/eval and memory/runtime continue to fill the public evidence surface. |` : `| Collection category | ${categoryLine} | 这是“仓库形态”：框架仍最多，但 benchmark/eval 与 memory/runtime 正在继续补公共证据面。 |`;
    ...
    const axisTime = en ? `| Time slice | ${timeLine} | Time signal: recent additions still concentrate in skills, memory, harness, evaluation, and self-modifying code. |` : `| Time slice | ${timeLine} | 这是“时间信号”：近期新增仍集中在 skills、memory、harness、evaluation 和 self-modifying code。 |`;
...
function updateGraphAndNotes() {
  ...
  graph.current_run = {
    ...
    gitnexus_status: 'available; local CLI exists, initial status was stale, reanalysis attempted in this iteration'
  };
