...
const runAt = '2026-05-29T10:08:08+08:00';
const runDate = '2026-05-29';
const runDisplay = '2026-05-29 10:08 +0800';
const runNote = 'work/research/hourly-public-metadata-update-2026-05-29-1008.md';
...
const repos = [
  {
    ...
    "rawFile": "raw-github/berriai_self-improving-agent.md",
    ...
    "stack": "TypeScript/GitHub Actions/Agent Self-Optimization Loop",
    "language": "TypeScript",
    "license": "MIT",
    "stars": 5,
    "forks": 0,
    ...
    "evidence": "web-observed GitHub page showed 5 stars, 0 forks, 15 commits, MIT license, and README framing around benchmark-plus-user-feedback self-improvement loops.",
    "excerpts": [
      "README asks whether AI coding agents can improve themselves by writing code and updating their own workflows over time.",
      "Current implementation uses benchmark + user feedback loops to drive self updates.",
      "Repo includes TypeScript workflows and CI scripts focused on iterative coding-agent optimization.",
  ...
  },
  {
    ...
    "rawFile": "raw-github/llmsecurity_awesome-agent-skills-security.md",
    ...
    "base_theme": "skill",
    "stack": "Markdown/Security Taxonomy/Skill Benchmark References",
    "language": "Markdown",
    "license": "CC0-1.0",
    "stars": 8,
    "forks": 9,
    ...
    "evidence": "web-observed GitHub page showed 8 stars, 9 forks, 17 commits, CC0-1.0 license, and README sections for benchmarks, attacks, and defenses.",
    "excerpts": [
      "README positions this list as secure and robust implementation resources for agent skills.",
      "Sections include benchmark frameworks, threat models, attack vectors, and defensive engineering links.",
      "Repository is tagged under security and benchmark-oriented resource collection usage.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "evidence": "web-observed GitHub page showed 223 stars, 26 forks, 7 commits, CC0-1.0 license, and README sections listing agent CLI stacks.",
    "excerpts": [
      "README brands the repository as a curated list of command-line tools for coding and operations agents.",
      "Entries are organized to help users discover practical agent CLI ecosystems quickly.",
      "Composio publishes this as an open index under CC0-1.0 for broad reuse.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/olshansk_agent-skills.md",
    ...
    "base_theme": "skill",
    "stack": "HTML/JavaScript Skill Bundles/Validation Scripts",
    "language": "HTML",
    "license": "MIT",
    "stars": 7,
    "forks": 0,
    ...
    "evidence": "web-observed GitHub page showed 7 stars, 0 forks, 150 commits, MIT license, and README instructions for curated installable skill sets.",
    "excerpts": [
      "README describes a collection of useful operational skills for coding assistants and automation agents.",
      "Repo includes automation scripts, documentation, and templates for installing and testing skills.",
      "Language mix on the public page is mainly HTML with supporting JavaScript tooling.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "evidence": "web-observed GitHub page showed 5 stars, 2 forks, 50 commits, and README documenting extraction/storage/retrieval architecture; no explicit license badge was visible on the page snapshot.",
    "excerpts": [
      "README states the project handles extracting, storing, and retrieving memory for agents.",
      "Architecture documentation highlights memory storage and retrieval pipeline components.",
      "Repository language signal is TypeScript with package.json and src-driven runtime structure.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/freedomintelligence_tiermem.md",
    ...
    "base_theme": "memory",
    "stack": "Python/Memory QA Benchmark/Provenance Evaluation",
    "language": "Python",
    "license": "MIT",
    "stars": 5,
    "forks": 1,
    ...
    "evidence": "web-observed GitHub page showed 5 stars, 1 fork, 24 commits, MIT license, and README framing around provenance-aware memory evaluation.",
    "excerpts": [
      "README presents TierMem as a benchmark for evaluating memory quality and provenance in personalized agents.",
      "The benchmark emphasizes grounded attribution and consistency, not only final response correctness.",
      "Implementation is Python-centric with dataset/evaluation scripts for reproducible memory studies.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  }
];
