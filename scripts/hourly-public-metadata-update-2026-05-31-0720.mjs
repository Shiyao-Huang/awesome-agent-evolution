...
const runAt = '2026-05-31T07:20:36+08:00';
const runDate = '2026-05-31';
const runDisplay = '2026-05-31 07:20 +0800';
const runNote = 'work/research/hourly-public-metadata-update-2026-05-31-0720.md';
...
const repos = [
  {
    ...
    "rawFile": "raw-github/martian-engineering_lossless-claw.md",
    ...
    "base_theme": "memory",
    "stack": "TypeScript/OpenClaw Plugin/Context Management Runtime",
    "language": "TypeScript",
    "license": "MIT",
    "stars": 4800,
    "forks": 410,
    ...
    "evidence": "web-observed GitHub page showed 4.8k stars, 410 forks, 376 commits, MIT license, and README framing around preserving and structuring AI agent context.",
    "excerpts": [
      "Repository tagline states this project helps make AI context lossless.",
      "README and About text focus on context management for OpenClaw workflows.",
      "Public page snapshot showed 4.8k stars, 410 forks, and 376 commits.",
  ...
  },
  {
    ...
    "rawFile": "raw-github/thinkwee_agentsmeetrl.md",
    ...
    "stack": "Markdown/Awesome List/Agentic RL Benchmark Survey",
    "language": "Markdown",
    "license": "Not listed",
    "stars": 1500,
    "forks": 203,
    ...
    "evidence": "web-observed GitHub page showed 1.5k stars, 203 forks, 146 commits, and repository messaging as an awesome list for Agentic RL resources.",
    "excerpts": [
      "Repository description calls it an Awesome List for Agentic RL.",
      "Language distribution indicates a markdown-first curation repository.",
      "Public page snapshot showed 1.5k stars, 203 forks, and 146 commits.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/syntax-syndicate_openharness-agent-harness.md",
    ...
    "stack": "Python/Agent Harness Runtime/Evaluation Pipeline",
    "language": "Python",
    "license": "MIT",
    "stars": 1,
    "forks": 0,
    ...
    "evidence": "web-observed GitHub page showed 1 star, 0 forks, 378 commits, MIT license, and explicit fork linkage to HKUDS/OpenHarness.",
    "excerpts": [
      "Repository title labels OpenHarness as an open agent harness.",
      "GitHub page marks this repository as a fork of HKUDS/OpenHarness.",
      "Public page snapshot showed 1 star, 0 forks, and 378 commits.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/arcadeai_openclaw-arcade-plugin.md",
    ...
    "base_theme": "skill",
    "stack": "TypeScript/OpenClaw Plugin/Arcade Tool Bridge",
    "language": "TypeScript",
    "license": "MIT",
    "stars": 4,
    "forks": 2,
    ...
    "evidence": "web-observed GitHub page showed 4 stars, 2 forks, 7 commits, MIT license, and README text about connecting OpenClaw to Arcade.dev tools.",
    "excerpts": [
      "README introduces an OpenClaw plugin that connects to Arcade.dev.",
      "Repository layout is plugin-centric and focused on reusable tool connectivity.",
      "Public page snapshot showed 4 stars, 2 forks, and 7 commits.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/humanitylabs-org_obsidianclaw.md",
    ...
    "base_theme": "memory",
    "stack": "TypeScript/OpenClaw Plugin/Obsidian Knowledge Sync",
    "language": "TypeScript",
    "license": "MIT",
    "stars": 6,
    "forks": 0,
    ...
    "evidence": "web-observed GitHub page showed 6 stars, 0 forks, 20 commits, MIT license, and archived status with an OpenClaw + Obsidian plugin description.",
    "excerpts": [
      "Repository description presents this as an OpenClaw plugin for Obsidian notes.",
      "GitHub page indicates the repository is archived and read-only.",
      "Public page snapshot showed 6 stars, 0 forks, and 20 commits.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/momo-personal-assistant_openclaw-plugin.md",
    ...
    "base_theme": "memory",
    "stack": "TypeScript/OpenClaw Personal Assistant Plugin/Task Memory",
    "language": "TypeScript",
    "license": "MIT",
    "stars": 15,
    "forks": 10,
    ...
    "evidence": "web-observed GitHub page showed 15 stars, 10 forks, 7 commits, MIT license, and README context as an OpenClaw plugin for the Momo assistant project.",
    "excerpts": [
      "Repository heading states this is the OpenClaw plugin for Momo personal assistant.",
      "Project framing is application-oriented rather than a generic framework release.",
      "Public page snapshot showed 15 stars, 10 forks, and 7 commits.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  }
];
