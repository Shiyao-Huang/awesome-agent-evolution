...
const runAt = '2026-06-01T19:51:04+08:00';
const runDate = '2026-06-01';
const runDisplay = '2026-06-01 19:51 +0800';
const runNote = 'work/research/hourly-public-metadata-update-2026-06-01-1951.md';
...
const repos = [
  {
    ...
    "rawFile": "raw-github/team-commonly_commonly.md",
    ...
    "stack": "TypeScript/Node.js/Agent Swarm Runtime",
    "language": "TypeScript",
    ...
    "evidence": "web-observed GitHub page showed 685 stars, 97 forks, 1,075 commits, and explicit AI swarm workflow operating system positioning.",
    "excerpts": [
      "Repository summary states it is an AI swarm workflow operating system.",
      "Public metadata snapshot showed 685 stars, 97 forks, and 1,075 commits.",
      "Repository structure highlights multi-agent workflow and orchestration components.",
  ...
  },
  {
    ...
    "rawFile": "raw-github/matevip_mateclaw.md",
    ...
    "base_theme": "memory",
    "stack": "Java/TypeScript/Spring AI Alibaba/OpenClaw Runtime",
    "language": "Java",
    "license": "Apache-2.0",
    "stars": 537,
    "forks": 184,
    ...
    "evidence": "web-observed GitHub page showed 537 stars, 184 forks, 1,020 commits, Apache-2.0 license, and OpenClaw runtime positioning.",
    "excerpts": [
      "Repository description highlights OpenClaw ecosystem extension with runtime automation.",
      "Public metadata snapshot showed 537 stars, 184 forks, and 1,020 commits.",
      "Public page indicates Apache-2.0 licensing signal.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/christinminor459_onionclaw.md",
    ...
    "base_theme": "skill",
    "stack": "Python/OpenClaw Plugin/Security Workflow",
    "language": "Python",
    "license": "License file present (public page)",
    "stars": 198,
    "forks": 56,
    ...
    "evidence": "web-observed GitHub page showed 198 stars, 56 forks, 48 commits, and explicit OPSEC plugin framing for OpenClaw.",
    "excerpts": [
      "Repository summary positions OnionClaw as OPSEC support for OpenClaw workflows.",
      "Public metadata snapshot showed 198 stars, 56 forks, and 48 commits.",
      "Repository scope centers on secure execution and hardened plugin tooling.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/nowledge-co_community.md",
    ...
    "base_theme": "skill",
    "stack": "TypeScript/OpenClaw Skills Hub/Community Runtime Patterns",
    "language": "TypeScript",
    "license": "License file present (public page)",
    "stars": 86,
    "forks": 21,
    ...
    "evidence": "web-observed GitHub page showed 86 stars, 21 forks, 492 commits, and explicit community resource positioning around OpenClaw.",
    "excerpts": [
      "Repository summary highlights a community hub around OpenClaw skills and integrations.",
      "Public metadata snapshot showed 86 stars, 21 forks, and 492 commits.",
      "Repository focus is ecosystem contribution and reusable skill sharing.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/0xnyk_lacp.md",
    ...
    "function_tag": "tool-module",
    "base_theme": "memory",
    "stack": "TypeScript/Protocol/Agent Context Exchange",
    "language": "TypeScript",
    "license": "License file present (public page)",
    "stars": 261,
    "forks": 33,
    ...
    "evidence": "web-observed GitHub page showed 261 stars, 33 forks, 249 commits, and protocol-oriented positioning for agent context exchange.",
    "excerpts": [
      "Repository description frames LACP as lightweight agent context protocol infrastructure.",
      "Public metadata snapshot showed 261 stars, 33 forks, and 249 commits.",
      "Repository emphasis is context interoperability across agent tooling.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/manthanguptaa_water.md",
    ...
    "base_theme": "evolution",
    "stack": "Python/Coding Agent/Self-Improvement Evaluation",
    "language": "Python",
    "license": "Apache-2.0",
    "stars": 288,
    "forks": 38,
    ...
    "evidence": "web-observed GitHub page showed 288 stars, 38 forks, 174 commits, Apache-2.0 license, and explicit self-improving coding-agent framing.",
    "excerpts": [
      "Repository summary states WATER is a self-improving coding agent project.",
      "Public metadata snapshot showed 288 stars, 38 forks, and 174 commits.",
      "Public page indicates Apache-2.0 licensing signal.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/sponsiolabs_sponsio.md",
    ...
    "function_tag": "framework-runtime",
    "base_theme": "harness",
    "stack": "TypeScript/Multi-Agent Workflow Control Plane",
    "language": "TypeScript",
    "license": "License file present (public page)",
    "stars": 469,
    "forks": 28,
    ...
    "evidence": "web-observed GitHub page showed 469 stars, 28 forks, 119 commits, and explicit workflow/multi-agent control-plane positioning.",
    "excerpts": [
      "Repository description emphasizes workflow and multi-agent control infrastructure.",
      "Public metadata snapshot showed 469 stars, 28 forks, and 119 commits.",
      "Repository scope focuses on orchestrated autonomous execution patterns.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  }
];
