...
const runAt = '2026-05-29T16:12:30+08:00';
const runDate = '2026-05-29';
const runDisplay = '2026-05-29 16:12 +0800';
const runNote = 'work/research/hourly-public-metadata-update-2026-05-29-1612.md';
...
const repos = [
  {
    ...
    "rawFile": "raw-github/itgoyo_awesome-agent-skills.md",
    ...
    "base_theme": "skill",
    "stack": "Markdown/MCP-Compatible Skill Registry/Workflow Resource Index",
    "language": "Markdown",
    ...
    "evidence": "web-observed GitHub page showed 112 stars, 10 forks, 4 commits, and README sections for multi-runtime skill resources; repository license was not explicit in metadata but README includes a CC BY 4.0 note.",
    "excerpts": [
      "README positions the repo as the complete guide to AI agent skills and skill tooling.",
      "Coverage explicitly spans Claude Code, Codex, Gemini CLI, Cline and Cursor ecosystems.",
      "Sections include official resources, tutorials, templates and integration links for practical adoption.",
  ...
  },
  {
    ...
    "rawFile": "raw-github/back1ply_agent-skill-loader.md",
    ...
    "base_theme": "skill",
    "stack": "TypeScript/Skill Loading Pipeline/Agent Runtime Integration",
    "language": "TypeScript",
    "license": "MIT",
    "stars": 10,
    "forks": 3,
    ...
    "evidence": "web-observed GitHub page showed 10 stars, 3 forks, 16 commits, MIT license, and README docs on loading external skills into agents.",
    "excerpts": [
      "README describes this project as a utility for importing and managing AI agent skills.",
      "Implementation files focus on loader logic and runtime integration behavior.",
      "The project is lightweight but directly relevant to reusable skill orchestration.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/da1yuqin_sead.md",
    ...
    "stack": "Python/Agent System Design Benchmark/Evolution Evaluation",
    "language": "Python",
    "license": "Apache-2.0",
    "stars": 20,
    "forks": 1,
    ...
    "evidence": "web-observed GitHub page showed 20 stars, 1 fork, 1 commit, Apache-2.0 license, and README claiming the first benchmark focused on self-evolving system design agents.",
    "excerpts": [
      "README frames SEAD as a benchmark for software system design agents.",
      "The page describes a self-evolving-agent context and quality-focused evaluation setup.",
      "Repo contents include benchmark data and task definitions for controlled comparison.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/ai-agents-2030_darwin-mobile-agent.md",
    ...
    "base_theme": "evolution",
    "stack": "Python/Mobile Agent Runtime/Self-Improvement Loop",
    "language": "Python",
    "license": "Apache-2.0",
    "stars": 10,
    "forks": 0,
    ...
    "evidence": "web-observed GitHub page showed 10 stars, 0 forks, 4 commits, Apache-2.0 license, and README references to a self-evolving mobile-agent architecture.",
    "excerpts": [
      "README introduces Darwin as a self-evolving mobile automation agent.",
      "Repository content links runtime components with dataset/evaluation support files.",
      "Language breakdown indicates a Python-heavy implementation with UI task artifacts.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/yuanchenbei_mem-gallery.md",
    "report": "projects/303-mem-gallery-memory-benchmark.md",
    "category": "Long-Term Memory Benchmark Suite",
    "final_category": "评测/evaluation",
    "function_tag": "benchmark-eval",
    "base_theme": "memory",
    "stack": "Python/Long-Term Memory Benchmark/LLM Agent Evaluation",
    "language": "Python",
    "license": "MIT",
    "stars": 36,
    "forks": 2,
    ...
    "evidence": "web-observed GitHub page showed 36 stars, 2 forks, 12 commits, MIT license, and README sections for benchmark datasets and evaluation pipelines.",
    "excerpts": [
      "README positions Mem-Gallery as a benchmark suite for long-term memory in language agents.",
      "The project includes data and evaluation components intended for reproducible comparison.",
      "Task design emphasizes memory quality under longer context and multi-turn usage.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/infiagent_infiagent.md",
    "report": "projects/304-infiagent-framework.md",
    "category": "Framework for Self-Improving Agent Loops",
    "final_category": "框架/framework",
    "function_tag": "agent-evolution-infra",
    "base_theme": "evolution",
    "stack": "Python/Agent Workflow Infrastructure/Self-Improvement Loop",
    "language": "Python",
    "license": "MIT",
    "stars": 1900,
    "forks": 235,
    ...
    "evidence": "web-observed GitHub page showed 1.9k stars, 235 forks, 12 commits, MIT license, and README framing around self-improving agent workflows.",
    "excerpts": [
      "README describes InfiAgent as an open-source framework for self-improving AI agents.",
      "Public page metadata shows strong community adoption relative to many newer loop frameworks.",
      "Repository structure includes workflow-oriented Python implementation assets.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  }
];
