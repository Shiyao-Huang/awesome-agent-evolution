...
const runAt = '2026-06-02T01:55:44+08:00';
const runDate = '2026-06-02';
const runDisplay = '2026-06-02 01:55 +0800';
const runNote = 'work/research/hourly-public-metadata-update-2026-06-02-0155.md';
...
const repos = [
  {
    ...
    "rawFile": "raw-github/zorazrw_agent-workflow-memory.md",
    ...
    "base_theme": "memory",
    "stack": "Python/FastAPI/LangChain/Neo4j/Workflow Memory",
    "language": "Python",
    "license": "Apache-2.0",
    "stars": 440,
    "forks": 50,
    ...
    "evidence": "web-observed GitHub page showed 440 stars, 50 forks, 25 commits, Apache-2.0 license, and explicit memory manager plus knowledge-graph workflow framing.",
    "excerpts": [
      "Repository summary states it is an Agent Workflow with Memory Management and Knowledge Graph.",
      "Public metadata snapshot showed 440 stars, 50 forks, and 25 commits.",
      "README sections describe Memory Manager, Workflow Manager, and FastAPI entrypoints.",
  ...
  },
  {
    ...
    "rawFile": "raw-github/webzler_agentmemory.md",
    ...
    "stack": "TypeScript/Benchmark Harness/Memory Evaluation",
    "language": "TypeScript",
    "license": "MIT",
    "stars": 28,
    "forks": 4,
    ...
    "evidence": "web-observed GitHub page showed 28 stars, 4 forks, 3 commits, MIT license, and explicit benchmark framing for evaluating memory capabilities in AI agents.",
    "excerpts": [
      "Repository summary says it is a benchmark framework for evaluating memory capabilities in AI agents.",
      "Public metadata snapshot showed 28 stars, 4 forks, and 3 commits.",
      "README includes objectives, benchmark architecture, and scorecard output sections.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/agiresearch_a-mem.md",
    ...
    "function_tag": "memory-runtime",
    "base_theme": "memory",
    "stack": "Python/LLM Agent Memory/Long-Term Retention",
    "language": "Python",
    "license": "MIT",
    "stars": 1000,
    "forks": 86,
    ...
    "evidence": "web-observed GitHub page showed 1k stars, 86 forks, 31 commits, MIT license, and explicit A-MEM agentic memory positioning for LLM agents.",
    "excerpts": [
      "Repository summary states A-MEM is Agentic Memory for LLM Agents.",
      "Public metadata snapshot showed 1k stars, 86 forks, and 31 commits.",
      "README includes environment setup, run steps, and notebook-oriented examples.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/elizaos_agentmemory.md",
    ...
    "base_theme": "memory",
    "stack": "Python/ElizaOS Plugin/Memory Runtime Integration",
    "language": "Python",
    "license": "MIT",
    "stars": 236,
    "forks": 57,
    ...
    "evidence": "web-observed GitHub page showed 236 stars, 57 forks, 123 commits, MIT license, and explicit plugin-level memory management framing for ElizaOS agents.",
    "excerpts": [
      "Repository summary says it enables agents in ElizaOS to manage memory for dynamic and contextual interactions.",
      "Public metadata snapshot showed 236 stars, 57 forks, and 123 commits.",
      "README documents plugin installation and memory environment setup for ElizaOS.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/apify_agent-skills.md",
    ...
    "base_theme": "skill",
    "stack": "Python/Agent Skills/Developer Workflow Library",
    "language": "Python",
    "license": "Apache-2.0",
    "stars": 2100,
    "forks": 228,
    ...
    "evidence": "web-observed GitHub page showed 2.1k stars, 228 forks, 152 commits, Apache-2.0 license, and explicit reusable coding-agent skills positioning.",
    "excerpts": [
      "Repository summary states it is a collection of useful skills to use with coding agents.",
      "Public metadata snapshot showed 2.1k stars, 228 forks, and 152 commits.",
      "README provides a large catalog of skills and practical usage patterns.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/openswarm-ai_openswarm.md",
    ...
    "base_theme": "harness",
    "stack": "Python/Multi-Agent Swarm/Runtime Orchestration",
    "language": "Python",
    "license": "MIT",
    "stars": 129,
    "forks": 16,
    ...
    "evidence": "web-observed GitHub page showed 129 stars, 16 forks, 91 commits, MIT license, and explicit lightweight multi-agent orchestration framing.",
    "excerpts": [
      "Repository summary states it is lightweight multi-agent orchestration.",
      "Public metadata snapshot showed 129 stars, 16 forks, and 91 commits.",
      "README includes quickstart and orchestration-focused examples.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  }
];
