...
const runAt = '2026-05-26T21:54:04+08:00';
const runDate = '2026-05-26';
const runDisplay = '2026-05-26 21:54 +0800';
const runNote = 'work/research/hourly-public-metadata-update-2026-05-26-2154.md';
...
const repos = [
  {
    ...
    stack: 'PDDL/Python/Shell/TypeScript/JavaScript/Scala',
    language: 'PDDL',
    license: 'Apache-2.0',
    stars: 1200,
    forks: 302,
    ...
    tags: ['benchmark', 'skills', 'evaluation harness', 'agent reliability', 'task composition'],
    ...
    evidence: 'web-observed GitHub page showed 1.2k stars, 302 forks, 360 commits, Apache-2.0 license, and README statements for deterministic skill evaluation workflows, task composition difficulty targets, and lockfile-based reproducible runs.',
    excerpts: [
      'The README describes SkillsBench as the first benchmark focused on how effectively agents use skills.',
      'Task design emphasizes multi-skill composition with low baseline success for stronger discrimination.',
      'Default tasks and excluded task sets are explicitly separated for reproducible benchmark behavior.',
      'The project uses uv lock and a BenchFlow runtime dependency path for repeatable experiment updates.'
    ]
  },
  {
    ...
    tags: ['meta-harness', 'harness engineering', 'agent evolution', 'benchmark', 'outer-loop search'],
    ...
    evidence: 'web-observed GitHub page showed 959 stars, 92 forks, 11 commits, MIT license, and README content for framework-level harness search, onboarding-driven domain adaptation, and separate optimized Terminal-Bench-2 artifact linkage.',
    excerpts: [
      'The repository positions harness code as a first-class optimization target around fixed model weights.',
      'Two reference experiments are included: text classification memory search and Terminal-Bench-2 scaffold evolution.',
      'ONBOARDING.md is the stated entrypoint for applying Meta-Harness to a new domain.',
      'The optimized Terminal-Bench-2 harness is explicitly separated into an artifact repository.'
    ]
  },
  {
    ...
    evidence: 'web-observed GitHub page showed 86 stars, 9 forks, 11 commits, MIT license, and README sections describing TBLite/TB2 benchmark orchestration, baseline-candidate comparability checks, deterministic wrapper mutation, and frontier-backed search.',
    excerpts: [
  ...
  },
  {
    ...
    rawFile: 'raw-github/zjunlp_skillx.md',
    ...
    tags: ['skills', 'knowledge base', 'experience learning', 'agent transfer', 'benchmark'],
    ...
    evidence: 'web-observed GitHub page showed 181 stars, 16 forks, 17 commits, MIT license, and README details for three-level skill abstraction plus iterative refinement and expansion across AppWorld, BFCL-v3, and τ2-Bench.',
    excerpts: [
      'SkillX distills experience into planning, functional, and atomic skill layers for transfer.',
      'The pipeline automates extraction, consolidation/filtering, and skill library updates.',
      'Exploratory expansion targets under-covered tools and failure-prone behaviors to grow coverage.',
      'README-reported benchmark gains emphasize both success-rate and execution-efficiency improvement.'
    ]
  }
];
