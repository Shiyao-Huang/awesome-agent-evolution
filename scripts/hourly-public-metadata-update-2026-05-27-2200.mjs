...
const runAt = '2026-05-27T22:00:12+08:00';
const runDate = '2026-05-27';
const runDisplay = '2026-05-27 22:00 +0800';
const runNote = 'work/research/hourly-public-metadata-update-2026-05-27-2200.md';
...
const repos = [
  {
    ...
    rawFile: 'raw-github/mindfold-ai_trellis.md',
    ...
    base_theme: 'memory',
    stack: 'Python/TypeScript/Rust/CDP/Docker',
    language: 'Python',
    license: 'AGPL-3.0',
    stars: 8500,
    forks: 466,
    ...
    tags: ['agent workspace', 'memory', 'browser automation', 'planner', 'runtime'],
    ...
    evidence: 'web-observed GitHub page showed 8.5k stars, 466 forks, 1,017 commits, AGPL-3.0 license, and README emphasis on visual agent workspace, memory structure, and high-frequency task loops.',
    excerpts: [
      'README positions Trellis as an open source cognitive workspace for autonomous agents.',
      'The architecture section highlights a clear logic layer above model calls and tool execution.',
      'The project provides browser interaction plus persistent workspace state for long-horizon tasks.',
      'No authenticated API metadata was used; evidence is from the publicly visible GitHub page snapshot.'
    ]
  },
  {
    ...
    rawFile: 'raw-github/picrew_awesome-agent-harness.md',
    ...
    stack: 'Markdown/Benchmark Catalog/Runtime Comparison',
    language: 'Markdown',
    license: 'Unknown',
    stars: 673,
    forks: 53,
    ...
    tags: ['harness', 'awesome-list', 'benchmark', 'evaluation', 'resource-index'],
    ...
    evidence: 'web-observed GitHub page showed 673 stars, 53 forks, 35 commits, and README sections covering benchmark suites, open-source frameworks, and end-to-end harness ecosystem mapping.',
    excerpts: [
      'The repository title explicitly frames it as an awesome list for building and evaluating AI agents with harnesses.',
      'README sections include benchmark suites and open-source harness framework catalogs.',
      'The list positions harness engineering as a bridge between runnable agents and measurable reliability.',
      'Public page evidence is used as raw metadata, without authenticated API augmentation.'
    ]
  },
  {
    ...
    tags: ['harness', 'awesome-list', 'benchmark', 'agent-eval', 'curation'],
    ...
    evidence: 'web-observed GitHub page showed 423 stars, 29 forks, 59 commits, and README positioning around comprehensive harness curation for AI agent reliability and benchmarking.',
    excerpts: [
  ...
  },
  {
    ...
    rawFile: 'raw-github/shareai-lab_learn-claude-code.md',
    ...
    base_theme: 'skill',
    stack: 'Markdown/CLI Skills/Workflow Playbooks',
    language: 'Markdown',
    license: 'MIT',
    stars: 63000,
    forks: 10300,
    ...
    tags: ['claude-code', 'skills', 'curriculum', 'workflow', 'coding-agent'],
    ...
    evidence: 'web-observed GitHub page showed 63k stars, 10.3k forks, 87 commits, MIT license, and README curriculum structure from setup to advanced automation practices.',
    excerpts: [
      'The project is presented as a complete beginner-to-advanced learning path for Claude Code.',
      'README includes daily task structures and workflow-focused practice modules.',
      'A dedicated section organizes practical command usage, patterns, and troubleshooting.',
      'Public-page metadata was captured directly; no authenticated GitHub API fields were consumed.'
    ]
  },
  {
    ...
    rawFile: 'raw-github/murataslan1_ai-agent-benchmark.md',
    ...
    base_theme: 'evaluation',
    stack: 'Markdown/JSON/Python Bench Scripts',
    language: 'Markdown',
    license: 'MIT',
    stars: 24,
    forks: 4,
    ...
    tags: ['benchmark', 'agent-evaluation', 'multi-domain', 'safety', 'comparison'],
    ...
    evidence: 'web-observed GitHub page showed 24 stars, 4 forks, 3 commits, MIT license, and README claims for 73 benchmark tasks spanning code, memory, translation, and safety categories.',
    excerpts: [
      'README states the benchmark covers coding, math, memory, translation, and safety dimensions.',
      'The task inventory is presented as 73 benchmark items with broad capability coverage.',
      'Model comparison examples are provided to demonstrate relative agent performance.',
      'Signals were captured from publicly visible repository metadata and README text only.'
    ]
  },
  {
    name: 'holaOS',
    ...
    tags: ['agent os', 'long-horizon', 'memory', 'context', 'self-evolving'],
    ...
    evidence: 'web-observed GitHub page showed 5.4k stars, 328 forks, 572 commits, Modified Apache 2.0 license, and README notes on being an environment for long-horizon work and self-evolving agents.',
    excerpts: [
      'The project tagline states it is an environment for long-horizon work and self-evolving agents.',
      'Language breakdown on the public page shows a TypeScript-dominant implementation.',
      'The repository metadata exposes sustained maintenance activity with hundreds of commits.',
      'This iteration records public evidence only and does not assert authenticated API freshness.'
    ]
  }
];
