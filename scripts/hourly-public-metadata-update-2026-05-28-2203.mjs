...
const runAt = '2026-05-28T22:03:48+08:00';
const runDate = '2026-05-28';
const runDisplay = '2026-05-28 22:03 +0800';
const runNote = 'work/research/hourly-public-metadata-update-2026-05-28-2203.md';
...
const repos = [
  {
    ...
    evidence: 'web-observed GitHub page showed 266 stars, 51 forks, 735 commits, MIT license, Python-first implementation, and README framing as fast/flexible memory for AI agents.',
    excerpts: [
  ...
  },
  {
    ...
    rawFile: 'raw-github/langchain-ai_memory-agent.md',
    ...
    base_theme: 'memory',
    stack: 'Python/LangGraph/LangMem',
    language: 'TypeScript',
    license: 'MIT',
    stars: 1800,
    forks: 51,
    ...
    tags: ['memory', 'langgraph', 'langmem', 'agent-workflow', 'evaluation'],
    ...
    evidence: 'web-observed GitHub page showed 1.8k stars, 51 forks, 33 commits, MIT license, and README guidance for memory-rich agent workflows.',
    excerpts: [
      'Repository tagline states this is a memory-enabled AI assistant template.',
      'README and docs reference LangGraph and LangMem integration for context retention.',
      'Project structure emphasizes reproducible local setup and workflow inspection.',
      'Counts were taken from the public GitHub page without authenticated API claims.'
    ]
  },
  {
    ...
    rawFile: 'raw-github/iflytek_skillhub.md',
    ...
    base_theme: 'skill',
    stack: 'C++/Go/TypeScript Multi-Agent Skill Platform',
    language: 'C++',
    license: 'Apache-2.0',
    stars: 3200,
    forks: 443,
    ...
    tags: ['skill', 'agent-platform', 'multi-agent', 'orchestration', 'runtime'],
    ...
    evidence: 'web-observed GitHub page showed 3.2k stars, 443 forks, 903 commits, Apache-2.0 license, and project messaging around an open-source AI Agent platform.',
    excerpts: [
  ...
  },
  {
    ...
    report: 'projects/284-mindfold-trellis-agent-harness.md',
    category: 'Agent Harness and Local/Cloud Runtime Framework',
    final_category: '框架/framework',
    function_tag: 'framework-runtime',
    base_theme: 'framework',
    stack: 'TypeScript/Node.js Agent Harness Runtime',
    language: 'TypeScript',
    license: 'AGPL-3.0',
    stars: 8600,
    forks: 468,
    commits: 1017,
    pattern: 'agent session planning -> deterministic harness/tool execution -> local/cloud runtime handoff -> human or evaluator feedback loop for iterative task completion',
    tags: ['harness', 'agent-runtime', 'typescript', 'local-cloud', 'workflow'],
    description: 'Trellis is an open-source harness for running and coordinating AI agents across local and cloud environments with practical workflow execution support.',
    evidence: 'web-observed GitHub page showed 8.6k stars, 468 forks, 1,017 commits, AGPL-3.0 license, and README positioning as an agent harness.',
    excerpts: [
  ...
  },
  {
    ...
    rawFile: 'raw-github/memodb-io_acontext.md',
    ...
    base_theme: 'memory',
    stack: 'TypeScript/Rust Agent Memory Infrastructure',
    language: 'TypeScript',
    license: 'Apache-2.0',
    stars: 3500,
    forks: 319,
    ...
    tags: ['memory', 'agent-skills', 'context-engine', 'runtime', 'long-term-memory'],
    ...
    evidence: 'web-observed GitHub page showed 3.5k stars, 319 forks, 1,080 commits, Apache-2.0 license, and README framing as a memory layer for agent skills.',
    excerpts: [
      'Repository tagline highlights Acontext as a memory layer for agent skills.',
      'Public metadata shows mixed TypeScript and Rust implementation signals.',
      'Documentation index includes architecture, modules, and memory lifecycle setup.',
      'Counts were taken from the public GitHub page without authenticated API claims.'
    ]
  },
  {
    ...
    tags: ['memory', 'episodic', 'knowledge-graph', 'context-retrieval', 'agent-state'],
    ...
    evidence: 'web-observed GitHub page showed 202 stars, 17 forks, 79 commits, MIT license, and project framing around episodic memory for autonomous agents.',
    excerpts: [
