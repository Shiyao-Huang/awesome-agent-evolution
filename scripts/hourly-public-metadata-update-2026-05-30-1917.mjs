...
const runAt = '2026-05-30T19:17:15+08:00';
const runDate = '2026-05-30';
const runDisplay = '2026-05-30 19:17 +0800';
const runNote = 'work/research/hourly-public-metadata-update-2026-05-30-1917.md';
...
const repos = [
  {
    ...
    "rawFile": "raw-github/aiming-lab_autoharness.md",
    ...
    "stack": "Python/TypeScript/Harness Governance Runtime",
    "language": "Python",
    "license": "MIT",
    "stars": 295,
    "forks": 23,
    ...
    "evidence": "web-observed GitHub page showed 295 stars, 23 forks, 8 commits, MIT license, and the explicit principle 'Agent = Model + Harness' with multi-mode governance.",
    "excerpts": [
      "README frames AutoHarness as automated harness engineering for AI agents.",
      "Public page states Agent = Model + Harness and emphasizes governance as the differentiator.",
      "Repository snapshot showed 295 stars, 23 forks, and 8 commits.",
  ...
  },
  {
    ...
    "rawFile": "raw-github/owasp_www-project-agent-memory-guard.md",
    ...
    "function_tag": "memory-safety",
    "base_theme": "memory",
    "stack": "Python/Agent Memory Security Middleware/Benchmarkable Guard",
    "language": "Python",
    "license": "Apache-2.0",
    "stars": 17,
    "forks": 10,
    ...
    "evidence": "web-observed GitHub page showed 17 stars, 10 forks, 140 commits, Apache-2.0 license, and README claims as OWASP reference implementation for ASI06 memory poisoning.",
    "excerpts": [
      "README positions this as a runtime defense for agent memory read/write paths.",
      "The project claims OWASP ASI06 memory-poisoning reference implementation status.",
      "Public page snapshot showed 17 stars, 10 forks, and 140 commits.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/addyosmani_agent-skills.md",
    ...
    "base_theme": "skill",
    "stack": "Shell/JavaScript/Structured Skill Workflows",
    "language": "Shell",
    "license": "MIT",
    "stars": 47000,
    "forks": 5200,
    ...
    "evidence": "web-observed GitHub page showed 47k stars, 5.2k forks, 201 commits, MIT license, and a documented pack of 23 structured skills.",
    "excerpts": [
      "README describes production-grade engineering skills for AI coding agents.",
      "The repo lists 23 structured skills with lifecycle-oriented workflows.",
      "Public page snapshot showed 47k stars, 5.2k forks, and 201 commits.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/zocomputer_skills.md",
    ...
    "base_theme": "skill",
    "stack": "TypeScript/Python/Skill Registry and Manifest Pipeline",
    "language": "TypeScript",
    "license": "MIT",
    "stars": 40,
    "forks": 40,
    ...
    "evidence": "web-observed GitHub page showed 40 stars, 40 forks, 126 commits, MIT license, and README positioning as an agent skills registry.",
    "excerpts": [
      "README introduces Zo Skills as an Agent Skills Registry for runtime installation.",
      "The repository documents validation, sync, and manifest-based distribution steps.",
      "Public page snapshot showed 40 stars, 40 forks, and 126 commits.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/qf-bench_quantitativefinance-bench.md",
    ...
    "stack": "Python/Harbor-based Benchmark Dataset/Sandbox Evaluation",
    "language": "Python",
    ...
    "evidence": "web-observed GitHub page showed 28 stars, 35 forks, 372 commits, and README documentation that the benchmark runs on Harbor with verifiable task outputs.",
    "excerpts": [
      "README labels QF-Bench as a state-aware interactive benchmark for financial agent tasks.",
      "Documentation states the dataset runs on Harbor for sandboxed evaluation.",
      "Public page snapshot showed 28 stars, 35 forks, and 372 commits.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "evidence": "web-observed GitHub page showed 34 stars, 4 forks, 49 commits, MIT license, and README claims of self-improving multi-agent defense via prompt optimization.",
    "excerpts": [
      "README describes orchestrator, deflector, responder, and evaluator roles in one defense workflow.",
      "Project text claims self-improving behavior through DSPy prompt optimization.",
      "Public page snapshot showed 34 stars, 4 forks, and 49 commits.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  }
];
