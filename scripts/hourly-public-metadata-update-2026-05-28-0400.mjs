...
const runAt = '2026-05-28T04:00:48+08:00';
const runDate = '2026-05-28';
const runDisplay = '2026-05-28 04:00 +0800';
const runNote = 'work/research/hourly-public-metadata-update-2026-05-28-0400.md';
...
const repos = [
  {
    ...
    rawFile: 'raw-github/langchain-ai_deepagents.md',
    ...
    stack: 'Python/TypeScript/LangGraph/LangSmith',
    language: 'Python',
    license: 'MIT',
    stars: 23400,
    forks: 3300,
    ...
    tags: ['harness', 'runtime', 'skills', 'memory', 'evaluation'],
    ...
    evidence: 'web-observed GitHub page showed 23.4k stars, 3.3k forks, 1,986 commits, MIT license, and README positioning as an open source agent harness with sub-agents, memory, and production-ready evaluation pathways.',
    excerpts: [
      'README describes Deep Agents as an open source agent harness that runs out of the box.',
      'Visible features include sub-agents, persistent memory, context management, and skills.',
      'README emphasizes production readiness on LangGraph with evaluation and tracing support.',
      'Counts were observed from the public repository page without authenticated API calls.'
    ]
  },
  {
    name: 'Archon',
    ...
    tags: ['harness', 'workflow-engine', 'coding-agent', 'validation', 'orchestration'],
    ...
    evidence: 'web-observed GitHub page showed 21.9k stars, 3.3k forks, 1,449 commits, MIT license, and README claims around deterministic workflow gates for coding agents.',
    excerpts: [
      'README positions Archon as the first open-source harness builder for AI coding.',
      'Workflow definitions are encoded in YAML for planning, implementation, validation, review, and PR steps.',
      'The project states deterministic run structure with isolated worktrees and composable validation nodes.',
      'All metadata comes from publicly visible repository content in this run.'
    ]
  },
  {
    ...
    rawFile: 'raw-github/ryanalberts_best-of-agent-harnesses.md',
    ...
    base_theme: 'evaluation',
    stack: 'Python/Shell/Generated Best-of Lists',
    language: 'Python',
    ...
    tags: ['awesome-list', 'harness', 'ranking', 'resource-index', 'evaluation'],
    ...
    evidence: 'web-observed GitHub page showed 45 stars, 4 forks, 47 commits, CC-BY-SA-4.0 license, and README framing as a ranked list of agent harnesses updated weekly.',
    excerpts: [
      'README declares a ranked list of 100+ agent harnesses and harness techniques.',
      'Repository navigation shows CC-BY-SA-4.0 licensing and best-of list generation structure.',
      'About section frames it as a weekly-updated ranking surface for harness engineering.',
      'Signals were captured from the public repository page in this iteration.'
    ]
  },
  {
    name: 'SkillOpt',
    ...
    tags: ['skill', 'self-evolving', 'optimizer', 'agent-training', 'workflow'],
    ...
    evidence: 'web-observed GitHub page showed 1.1k stars, 100 forks, 50 commits, MIT license, and README emphasis on trajectory-driven skill optimization without changing base model weights.',
    excerpts: [
  ...
  },
  {
    ...
    rawFile: 'raw-github/tencent_tencentdb-agent-memory.md',
    ...
    base_theme: 'memory',
    stack: 'TypeScript/Python/OpenClaw Plugin',
    language: 'TypeScript',
    license: 'MIT',
    stars: 4300,
    forks: 354,
    ...
    tags: ['memory', 'long-term-memory', 'openclaw', 'local-first', 'plugin'],
    ...
    evidence: 'web-observed GitHub page showed 4.3k stars, 354 forks, 74 commits, license badge indicating MIT, and README claims of a 4-tier local memory pipeline with OpenClaw benchmark improvements.',
    excerpts: [
      'README highlights a symbolic short-term plus layered long-term memory architecture.',
      'Published benchmark table reports token reduction and pass-rate gains when integrated with OpenClaw.',
      'Repository includes plugin and migration documents for memory-layer operations.',
      'Evidence remains public-page observed due API/auth blockers in shell.'
    ]
  },
  {
    name: 'GitTaskBench',
    ...
    rawFile: 'raw-github/quantaalpha_gittaskbench.md',
    ...
    base_theme: 'evaluation',
    stack: 'Python/Jupyter/C++/Benchmark Tooling',
    language: 'Python',
    license: 'Unknown',
    stars: 255,
    forks: 20,
    ...
    tags: ['benchmark', 'code-agent', 'repo-level', 'evaluation', 'harness'],
    ...
    evidence: 'web-observed GitHub page showed 255 stars, 20 forks, 84 commits, README benchmark framing for repo-level code-agent evaluation, and no explicit repository license marker in the navigation snapshot.',
    excerpts: [
      'README introduces GitTaskBench as a repo-level benchmark and tooling suite for real-world tasks.',
      'Repository structure includes scripts and outputs for multiple coding-agent runners.',
      'The benchmark narrative emphasizes cost-aware metrics and incremental task execution.',
      'All values were captured from the public page without authenticated freshness claims.'
    ]
  }
];
