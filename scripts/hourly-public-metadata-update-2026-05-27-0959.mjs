...
const runAt = '2026-05-27T09:59:08+08:00';
const runDate = '2026-05-27';
const runDisplay = '2026-05-27 09:59 +0800';
const runNote = 'work/research/hourly-public-metadata-update-2026-05-27-0959.md';
...
const repos = [
  {
    ...
    rawFile: 'raw-github/mem9-ai_mem9.md',
    ...
    base_theme: 'memory',
    stack: 'Go/TypeScript/OpenClaw/Hermes/Codex/Dify',
    language: 'Go',
    license: 'Apache-2.0',
    stars: 1100,
    forks: 111,
    ...
    tags: ['memory', 'multi-agent', 'openclaw', 'codex', 'persistent context'],
    ...
    evidence: 'web-observed GitHub page showed 1.1k stars, 111 forks, 433 commits, Apache-2.0 license, and README claims for OpenClaw/Hermes/Claude Code/OpenCode/Codex/Dify integrations with shared API-driven memory.',
    excerpts: [
      'The README positions mem9 as persistent memory across sessions and machines, not a single-chat cache.',
      'Supported runtimes include OpenClaw, Hermes Agent, Claude Code, OpenCode, Codex, and Dify.',
      'The repository exposes benchmark, server, plugin, and dashboard paths as a full memory stack.',
      'The same store/search/update/delete memory flow is shared across all listed integrations.'
    ]
  },
  {
    ...
    tags: ['memory plugin', 'lancedb', 'openclaw', 'hybrid retrieval', 'agent context'],
    ...
    evidence: 'web-observed GitHub page showed 4.4k stars, 725 forks, 459 commits, MIT license signal, and README notes for OpenClaw memory assistant behavior with hybrid retrieval and plugin lifecycle tooling.',
    excerpts: [
      'The repository describes itself as an OpenClaw AI memory assistant with long-term recall.',
      'Feature claims include auto-capture, multi-scope isolation, and vector-plus-fulltext retrieval.',
      'The README exposes operational commands for backup, migration, and upgrade paths.',
      'Docs reference OpenClaw 2026.3+ hook adaptation and compatibility constraints.'
    ]
  },
  {
    name: 'GBrain',
    ...
    rawFile: 'raw-github/garrytan_gbrain.md',
    ...
    base_theme: 'memory',
    stack: 'TypeScript/Markdown/Knowledge Graph/OpenClaw',
    language: 'TypeScript',
    license: 'MIT',
    stars: 19200,
    forks: 2700,
    ...
    tags: ['memory substrate', 'knowledge graph', 'openclaw', 'hermes', 'agent ops'],
    ...
    evidence: 'web-observed GitHub page showed 19.2k stars, 2.7k forks, 255 commits, MIT license, and README claims for large-scale personal/company brain operations with graph-aware retrieval and synthesis.',
    excerpts: [
      'The README positions GBrain as a synthesis and graph traversal layer beyond plain search.',
      'Repository structure includes docs, evals, skills, and operational scripts for sustained agent use.',
      'The project claims OpenClaw/Hermes deployment patterns and recurring background maintenance loops.',
      'A dedicated LICENSE file confirms MIT license text.'
    ]
  },
  {
    name: 'Akephalos',
    ...
    rawFile: 'raw-github/sunnja69_akephalos.md',
    ...
    base_theme: 'memory',
    stack: 'TypeScript/Markdown/JSONL/CLI',
    language: 'TypeScript',
    license: 'MIT',
    stars: 0,
    forks: 1,
    ...
    tags: ['local-first', 'agent passport', 'memory portability', 'markdown', 'mcp'],
    ...
    evidence: 'web-observed GitHub page showed 0 stars, 1 fork, 3 commits, MIT license signal, and README workflow for local .akephalos bundles, memory ledgers, and agent bootstrap prompts.',
    excerpts: [
      'The README emphasizes markdown-first local bundles rather than hosted memory services.',
      'It defines .akephalos files for identity, rules, tools, projects, and memories.',
      'The project documents Codex, Claude Code, OpenClaw/Hermes, and MCP integration points.',
      'Design scope explicitly excludes secret management and centralized cloud dashboards.'
    ]
  },
  {
    ...
    rawFile: 'raw-github/internscience_internagent.md',
    ...
    stack: 'Python/Shell/Deep-Research/Experiment Orchestration',
    language: 'Python',
    license: 'Apache-2.0',
    stars: 1300,
    forks: 116,
    ...
    tags: ['research agent', 'scientific discovery', 'multi-agent', 'benchmark', 'memory'],
    ...
    evidence: 'web-observed GitHub page (redirect from Alpha-Innovator/InternAgent to InternScience/InternAgent) showed 1.3k stars, 116 forks, 45 commits, Apache-2.0 license, and README news covering open-sourced 1.5 features plus deep-research/benchmark positioning.',
    excerpts: [
      'The repository README describes end-to-end autonomous scientific discovery workflows.',
      'News entries mention 2026 releases with memory module and deep research capabilities.',
      'The codebase exposes discovery and QA launch paths plus reproducible task scripts.',
      'The project links benchmark-facing scientific reasoning claims with public setup instructions.'
    ]
  }
];
