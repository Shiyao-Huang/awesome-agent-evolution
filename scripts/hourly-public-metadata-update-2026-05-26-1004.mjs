...
const runAt = '2026-05-26T10:04:13+08:00';
const runDate = '2026-05-26';
const runNote = 'work/research/hourly-public-metadata-update-2026-05-26-1001.md';
...
const repos = [
  {
    ...
    rawFile: 'raw-github/sd0xdev_sd0x-dev-flow.md',
    ...
    base_theme: 'skill',
    stack: 'JavaScript/TypeScript/Claude Code hooks',
    language: 'TypeScript',
    license: 'MIT',
    stars: 157,
    forks: 21,
    ...
    tags: ['harness', 'Claude Code', 'safety gates', 'skill orchestration', 'agent workflow'],
    ...
    evidence: 'web-observed GitHub page showed 157 stars, 21 forks, 456 commits, MIT license, and README claims for hook-enforced dual review, state-machine gate checks, fail-closed policies, and a large bundled public skill set for coding-agent operations.',
    excerpts: [
      'The README positions the repository as a harness layer around Claude Code, not a model-only prompting tweak.',
      'Visible sections emphasize hook lifecycle controls and a state-machine gating model for run safety.',
      'Dual-review and fail-closed guardrails are presented as non-skippable enforcement points for risky actions.',
      'A large reusable skill/rule asset layer is bundled to standardize repeated agent workflow behavior.'
    ]
  },
  {
    name: 'Utah',
    ...
    rawFile: 'raw-github/inngest_utah.md',
    ...
    stack: 'TypeScript/Inngest/pi-ai/skills',
    language: 'TypeScript',
    license: 'Apache-2.0',
    stars: 116,
    forks: 2,
    ...
    tags: ['harness', 'event-driven', 'Inngest', 'agent memory', 'skills'],
    ...
    evidence: 'web-observed GitHub page showed 116 stars, 2 forks, 41 commits, Apache-2.0 license, and README language for durable event-driven execution with retry/cancel behavior, channel adapters, skills, file-based memory, and workspace eval traces.',
    excerpts: [
      'The README describes a universally triggered harness that executes think-act-observe loops as event functions.',
      'Visible architecture highlights retries, singleton concurrency, cancel-on-new-message behavior and local worker connectivity.',
      'Repository structure includes skill assets, workspace evaluations, session traces and file-based memory surfaces.',
      'Adapters for channels like Telegram and Slack frame the harness as a runtime integration layer.'
    ]
  },
  {
    name: 'Meta Harness',
    ...
    rawFile: 'raw-github/superagenticai_metaharness.md',
    ...
    stack: 'Python/Codex CLI/Ollama benchmark harness',
    language: 'Python',
    ...
    tags: ['benchmark harness', 'Codex CLI', 'Ollama', 'proposal ledger', 'agent optimization'],
    ...
    evidence: 'web-observed GitHub page showed 102 stars, 11 forks, 23 commits, and README language for Codex-first benchmark loops, proposal/evaluate/keep harness iterations, candidate ledgers, write-scope controls, and experiment matrix support.',
    excerpts: [
      'The README describes an outer optimization loop focused on harness engineering rather than prompt-only tuning.',
      'Visible workflow states include proposing changes, validating against benchmark tasks, and retaining best candidates.',
      'Run ledgers and candidate artifacts are emphasized for reproducibility and auditability.',
      'Codex CLI and local Ollama paths appear as explicit runtime backends for repeated benchmark iterations.'
    ]
  }
];
