...
const runAt = '2026-06-01T01:50:26+08:00';
const runDate = '2026-06-01';
const runDisplay = '2026-06-01 01:50 +0800';
const runNote = 'work/research/hourly-public-metadata-update-2026-06-01-0150.md';
...
const repos = [
  {
    ...
    "stack": "TypeScript/OpenClaw Playground/Workflow Benchmark Harness",
    "language": "TypeScript",
    "license": "MIT",
    "stars": 96,
    "forks": 5,
    "commits": 27,
    "pattern": "assemble OpenClaw plugins and workflow variants in a runnable playground -> execute and benchmark workflow candidates against concrete tasks -> keep the best plugin/workflow combinations as retained operating recipes -> iterate toward self-improving agent behavior through explicit evaluation loops",
    "tags": ["evolution", "openclaw", "harness", "benchmark", "workflow"],
    "description": "longmans/self-evolve is a vibe-coding playground for building, running, and benchmarking OpenClaw plugins and workflows with local agents and MCP integrations.",
    "evidence": "web-observed GitHub page showed 96 stars, 5 forks, 27 commits, MIT license, and TypeScript code with explicit OpenClaw self-evolve workflow positioning.",
    "excerpts": [
      "Repository tagline describes a playground to build, run, and benchmark OpenClaw plugins and workflows.",
      "README framing highlights self-evolve workflow direction and local/MCP integration.",
      "Public page snapshot showed 96 stars, 5 forks, and 27 commits.",
  ...
  },
  {
    ...
    "rawFile": "raw-github/mckruz_openclaw-langfuse.md",
    ...
    "function_tag": "observability-telemetry",
    "base_theme": "evaluation",
    "stack": "JavaScript/OpenClaw Plugin/Langfuse Tracing",
    "language": "JavaScript",
    "license": "MIT",
    "stars": 1,
    "forks": 0,
    ...
    "tags": ["openclaw", "langfuse", "observability", "tracing", "plugin"],
    "description": "MCKRUZ/openclaw-langfuse adds Langfuse observability to OpenClaw through a lightweight plugin bridge.",
    "evidence": "web-observed GitHub page showed 1 star, 0 forks, 2 commits, MIT license, and JavaScript implementation for OpenClaw-Langfuse integration.",
    "excerpts": [
      "Repository title presents a Langfuse plugin for OpenClaw.",
      "Public metadata indicates MIT licensing and early-stage plugin footprint.",
      "Public page snapshot showed 1 star, 0 forks, and 2 commits.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/hyperspell_hyperspell-openclaw.md",
    ...
    "base_theme": "memory",
    "stack": "TypeScript/OpenClaw Memory Plugin/Context Synchronization",
    "language": "TypeScript",
    "license": "MIT",
    "stars": 181,
    "forks": 35,
    ...
    "tags": ["memory", "context", "openclaw", "plugin", "typescript"],
    ...
    "evidence": "web-observed GitHub page showed 181 stars, 35 forks, 60 commits, MIT license, and TypeScript-only implementation.",
    "excerpts": [
      "Repository summary highlights context and memory enhancement for OpenClaw.",
      "Language breakdown indicates a TypeScript-centric plugin/runtime design.",
      "Public page snapshot showed 181 stars, 35 forks, and 60 commits.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/composio-community_awesome-openclaw-plugins.md",
    ...
    "base_theme": "skill",
    "stack": "TypeScript/OpenClaw Plugin Registry/Resource Index",
    "language": "TypeScript",
    "license": "CC0-1.0",
    "stars": 43,
    "forks": 10,
    ...
    "tags": ["openclaw", "plugins", "awesome-list", "skills", "resource-index"],
    ...
    "evidence": "web-observed GitHub page showed 43 stars, 10 forks, 6 commits, CC0-1.0 license, and TypeScript-based plugin resource structure.",
    "excerpts": [
      "Repository is framed as a curated list of OpenClaw plugins with install-ready modules.",
      "README taxonomy covers memory, security, observability, and multi-agent plugin tracks.",
      "Public page snapshot showed 43 stars, 10 forks, and 6 commits.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/mvanhorn_last30days-skill.md",
    ...
    "base_theme": "evaluation",
    "stack": "Python/Benchmark Harness/Agent Skill Evaluation",
    "language": "Python",
    "license": "MIT",
    "stars": 1300,
    "forks": 147,
    ...
    "tags": ["benchmark", "evaluation", "skills", "harness", "python"],
    ...
    "evidence": "web-observed GitHub page showed 1.3k stars, 147 forks, 620 commits, MIT license, and Python-dominant benchmark implementation.",
    "excerpts": [
      "Repository has long-running history oriented around skill benchmarking workflows.",
      "Public metadata shows high commit volume and broad adoption for evaluation use.",
      "Public page snapshot showed 1.3k stars, 147 forks, and 620 commits.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/eesiz_clawdreamer.md",
    ...
    "function_tag": "application-demo",
    "base_theme": "skill",
    "stack": "Python/OpenClaw Automation Plugin/Workflow Assistant",
    "language": "Python",
    "license": "MIT",
    "stars": 23,
    "forks": 5,
    ...
    "tags": ["openclaw", "automation", "plugin", "application", "python"],
    "description": "EESIZ/clawdreamer offers an OpenClaw-oriented automation app/plugin for productivity and workflow execution.",
    "evidence": "web-observed GitHub page showed 23 stars, 5 forks, 9 commits, MIT license, and Python-only implementation.",
    "excerpts": [
      "Repository framing emphasizes OpenClaw automation application workflows.",
      "Public metadata indicates an early but focused plugin/app release footprint.",
      "Public page snapshot showed 23 stars, 5 forks, and 9 commits.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/thisisjeron_awesome-openclaw-plugins.md",
    ...
    "function_tag": "resource-index",
    "base_theme": "skill",
    "stack": "Markdown/OpenClaw Plugin Catalog/Community Resource Index",
    "language": "Markdown",
    "license": "CC0-1.0",
    "stars": 13,
    "forks": 12,
    ...
    "tags": ["openclaw", "plugins", "resource-index", "community", "skills"],
    ...
    "evidence": "web-observed GitHub page showed 13 stars, 12 forks, 31 commits, CC0 licensing signal, and a plugin-category focused README index.",
    "excerpts": [
      "Repository positions itself as a curated plugin list for OpenClaw.",
      "README includes structured taxonomy across memory, governance, observability, and self-improvement.",
      "Public page snapshot showed 13 stars, 12 forks, and 31 commits.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  },
  {
    ...
    "rawFile": "raw-github/blockrunai_awesome-openclaw-money-maker.md",
    ...
    "function_tag": "resource-index",
    "base_theme": "skill",
    "stack": "Markdown/OpenClaw Use-Case Index/Monetization Workflow Guide",
    "language": "Markdown",
    "license": "CC0-1.0",
    "stars": 261,
    "forks": 45,
    ...
    "tags": ["openclaw", "use-cases", "automation", "resource-index", "monetization"],
    ...
    "evidence": "web-observed GitHub page showed 261 stars, 45 forks, 25 commits, CC0 licensing signal, and a curated OpenClaw workflow index.",
    "excerpts": [
      "Repository provides a curated list of OpenClaw automations, skills, and strategies.",
      "README includes cost, security, and workflow guidance tied to production usage.",
      "Public page snapshot showed 261 stars, 45 forks, and 25 commits.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  }
];
