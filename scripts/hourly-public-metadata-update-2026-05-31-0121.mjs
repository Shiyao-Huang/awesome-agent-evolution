...
const runAt = '2026-05-31T01:21:52+08:00';
const runDate = '2026-05-31';
const runDisplay = '2026-05-31 01:21 +0800';
const runNote = 'work/research/hourly-public-metadata-update-2026-05-31-0121.md';
...
const repos = [
  {
    ...
    "rawFile": "raw-github/evomap_evolver.md",
    ...
    "base_theme": "memory",
    "stack": "JavaScript/Graph Memory Evolution Runtime/Reasoning Retrieval",
    "language": "JavaScript",
    "license": "GPL-3.0",
    "stars": 7600,
    "forks": 773,
    ...
    "evidence": "web-observed GitHub page showed 7.6k stars, 773 forks, 87 commits, GPL-3.0 license, and README positioning around self-evolving memory maps for AI reasoning.",
    "excerpts": [
      "README introduces Evolver as a framework for dynamic and self-evolving memory construction.",
      "Project text emphasizes adapting memory maps from interaction feedback to improve retrieval relevance.",
      "Public page snapshot showed 7.6k stars, 773 forks, and 87 commits.",
  ...
  },
  {
    ...
    "rawFile": "raw-github/nousresearch_hermes-agent-self-evolution.md",
    ...
    "stack": "Python/RL Distillation Pipeline/Self-Evolution Agent Training",
    "language": "Python",
    "license": "MIT",
    "stars": 3700,
    "forks": 422,
    ...
    "evidence": "web-observed GitHub page showed 3.7k stars, 422 forks, 7 commits, MIT-licensed model card references, and explicit self-evolution benchmark claims.",
    "excerpts": [
  ...
  },
  {
    ...
    "rawFile": "raw-github/knowall-ai_mcp-neo4j-agent-memory.md",
    ...
    "base_theme": "memory",
    "stack": "TypeScript/Neo4j MCP Server/Vector Memory Store",
    "language": "TypeScript",
    "license": "MIT",
    "stars": 68,
    "forks": 15,
    ...
    "evidence": "web-observed GitHub page showed 68 stars, 15 forks, 52 commits, MIT license, and README claims about long-term graph memory for AI agents.",
    "excerpts": [
  ...
  },
  {
    ...
    "rawFile": "raw-github/learnprompt_cc-harness-skills.md",
    ...
    "base_theme": "skill",
    "stack": "Markdown/Harness Skill Playbooks/Codex-Claude Workflows",
    "language": "Markdown",
    "license": "MIT",
    "stars": 217,
    "forks": 63,
    ...
    "evidence": "web-observed GitHub page showed 217 stars, 63 forks, 2 commits, MIT license, and repository messaging focused on installable harness skills.",
    "excerpts": [
  ...
  },
  {
    ...
    "rawFile": "raw-github/aiming-lab_clawarena.md",
    ...
    "stack": "Python/Computer-Use Benchmark Arena/Multi-Agent Harness",
    "language": "Python",
    "license": "MIT",
    "stars": 47,
    "forks": 0,
    ...
    "evidence": "web-observed GitHub page showed 47 stars, 0 forks, 4 commits, MIT license, and explicit benchmark arena framing for computer-use agents.",
    "excerpts": [
  ...
  },
  {
    ...
    "rawFile": "raw-github/kodustech_awesome-agent-skills.md",
    ...
    "base_theme": "skill",
    "stack": "Markdown/Agent Skill Catalog/Reusable Prompt Patterns",
    "language": "Markdown",
    "license": "CC0-1.0",
    "stars": 71,
    "forks": 29,
    ...
    "evidence": "web-observed GitHub page showed 71 stars, 29 forks, 36 commits, CC0-1.0 license, and README positioning as an awesome list of coding-agent skills.",
    "excerpts": [
      "README positions the project as an awesome list of reusable coding-agent skills.",
      "The repository catalogs skill patterns meant for direct reuse in engineering workflows.",
      "Public page snapshot showed 71 stars, 29 forks, and 36 commits.",
      "Counts were taken from the public GitHub page without authenticated API claims."
    ]
  }
];
