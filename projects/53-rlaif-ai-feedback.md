...
| 字段 | 内容 |
|------|------|
| 仓库 | recursive-rlaif/recursive-rlaif (参考实现) |
| GitHub URL | https://github.com/CarperAI/RLAIF |
| Stars | ~200 |
| 语言 | Python |
| 许可 | MIT |
| 最近活跃 | 2024 |
...
## 概述
RLAIF (Reinforcement Learning from AI Feedback) 是将 RLHF 中的人类反馈替换为 AI 系统反馈的对齐方法。该方法由 Anthropic 在论文 "Constitutional AI" 中提出并推广，核心思想是使用一个 AI 模型 (通常是更强的 LLM) 来替代人类进行偏好标注和安全评估。RLAIF 通过预定义的"宪法" (Constitution) 规则指导 AI 评估，实现了对齐过程的自动化和规模化。后续研究 (Recursive RLAIF) 展示了 RLAIF 可以递归地应用于自身，实现持续自我改进。
