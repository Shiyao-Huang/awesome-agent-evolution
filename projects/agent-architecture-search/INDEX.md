...
> 生成日期: 2026-05-22 | 更新: 2026-05-22 | 覆盖: 29+ 项目 | 方向负责人: Researcher-1
> 搜索范围: ADAS, DGM, Gödel Agent, Agent 自进化框架, 架构搜索, 技能进化, 2026 生态
...
### 八、2026 生态项目 (2026 Ecosystem Projects)

| # | 项目 | Stars | 语言 | 机构 | 核心定位 |
|---|------|-------|------|------|----------|
| 22 | [Claw Code](./22-claw-code.md) | 192K+ | Rust+Python | UltraWorkers | Claude Code Rust 开源实现, 终端 Agent |
| 23 | [Gemini CLI](./23-gemini-cli.md) | 新 | TypeScript | Google | Gemini 官方终端 Agent, 1M 上下文 |
| 24 | [DeepSeek-V3](./24-deepseek-v3.md) | 高 | Python | DeepSeek | 671B MoE 模型, FP8 训练, 极低成本 |
| 25 | [n8n](./25-n8n.md) | 80K+ | TypeScript | n8n GmbH | 400+ 集成工作流自动化, AI 原生 |
| 26 | [Langflow](./26-langflow.md) | 60K+ | Python+TS | Langflow AI | AI Agent 可视化构建, MCP 部署 |

### 九、Survey 列表 (Curated Lists)

| # | 项目 | Stars | 覆盖范围 |
|---|------|-------|----------|
| 27 | [Awesome-Self-Evolving-Agents](./surveys.md) | 300+ | 最全的自进化 Agent 论文索引 |
| 28 | [Self-Evolving-Agents](./surveys.md) | 200+ | 自进化 Agent 分类综述 |
| 29 | [Awesome-Agent-Evolution](./surveys.md) | 113 | Agent 进化资源列表 |
...
| **TypeScript** | 3 | Gemini CLI, n8n, Langflow(前端) |
| **Rust** | 1 | Claw Code |
...
| **工作流编排** | n8n, Langflow | 可视化 Agent 工作流构建+部署 |
| **CLI Agent** | Claw Code, Gemini CLI | 终端 AI Agent, MCP 支持 |
...
8. **2026 CLI Agent 三巨头** — Claude Code + Gemini CLI + Claw Code 构成终端 Agent 格局
9. **n8n + Langflow 构成工作流基础设施** — 400+/900+ 模板, AI 原生, MCP 支持
10. **DeepSeek-V3 证明开源模型成本极限** — 671B MoE 仅需 2.788M GPU 小时, FP8 训练首创
