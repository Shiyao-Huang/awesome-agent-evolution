...
The raw capture now reflects a GitHub metadata packet observed on 2026-07-01: 24,384 stars, 2,001 forks, 463 commits, 167 open issues, and 181 open pull requests. This packet is fresher than the previous authenticated packet at 2026-07-01 11:09 +0800 where a delta was observed. This run did not execute the repository locally, validate workflows end to end, or independently rerun benchmark claims. Product, memory, benchmark, and automation claims therefore remain repository-scoped unless separately tested.
