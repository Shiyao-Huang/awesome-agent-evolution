---
review_id: review-2402.17574
arxiv_id: 2402.17574
source_file: raw-papers/2402-17574.md
...
# Deep Academic Review: Agent-Pro: Learning to Evolve via Policy-Level Reflection and Optimization
...
- **Original content timestamp:** 2024-02-27
- **Time slice:** 2024-Q1
- **Source artifact:** `raw-papers/2402-17574.md`
...
Relative to **Reflexion**, this work can be understood as another route to converting failure signals into future behavioral improvement. Reflexion emphasizes verbal reinforcement and episodic memory; Agent-Pro: Learning to Evolve via Policy-Level Reflection and Optimization emphasizes the specific mechanism described in its task setting. Relative to **Self-Refine**, the common pattern is iterative feedback and revision, but the practical difference is how feedback is generated and whether it is grounded enough to avoid circular self-approval.
